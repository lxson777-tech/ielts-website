...
GROUPS: dict[int, list[list[tuple[int, int, str, str]]]] = {
    1: [[(1, 5, "sentence-completion", "Complete the table below."), (6, 10, "sentence-completion", "Complete the table below.")], [(11, 13, "multiple-choice", "Choose the correct letter, A, B or C."), (14, 18, "matching-features", "Choose FIVE answers from the box."), (19, 20, "sentence-completion", "Complete the table below.")], [(21, 30, "sentence-completion", "Complete the notes below.")], [(31, 32, "multiple-choice", "Choose the correct letter, A, B or C."), (33, 40, "sentence-completion", "Complete the notes below.")]],
    2: [[(1, 10, "sentence-completion", "Complete the form below.")], [(11, 13, "sentence-completion", "Complete the table below."), (14, 16, "multiple-choice", "Choose the correct letter, A, B or C."), (17, 20, "matching-features", "Label the map below.")], [(21, 24, "multiple-choice", "Choose the correct letter, A, B or C."), (25, 30, "sentence-completion", "Complete the notes below.")], [(31, 40, "sentence-completion", "Complete the notes below.")]],
    3: [[(1, 10, "sentence-completion", "Complete the notes below.")], [(11, 16, "sentence-completion", "Complete the notes below."), (17, 18, "multiple-choice", "Choose the correct letter, A, B or C."), (19, 20, "multiple-answer", "Choose TWO letters, A-E.")], [(21, 30, "multiple-choice", "Choose the correct letter, A, B or C.")], [(31, 40, "sentence-completion", "Complete the notes below.")]],
    4: [[(1, 10, "sentence-completion", "Complete the notes below.")], [(11, 13, "multiple-choice", "Choose the correct letter, A, B or C."), (14, 20, "matching-features", "Label the map below.")], [(21, 22, "multiple-answer", "Choose TWO letters, A-E."), (23, 24, "multiple-answer", "Choose TWO letters, A-E."), (25, 26, "multiple-choice", "Choose the correct letter, A, B or C."), (27, 30, "sentence-completion", "Complete the flow chart below.")], [(31, 36, "matching-features", "Write the correct letter, A, B or C."), (37, 40, "sentence-completion", "Complete the notes below.")]],
    5: [[(1, 3, "sentence-completion", "Complete the form below."), (4, 8, "sentence-completion", "Complete the table below."), (9, 10, "multiple-answer", "Choose TWO letters, A-E.")], [(11, 16, "sentence-completion", "Complete the notes below."), (17, 20, "sentence-completion", "Complete the table below.")], [(21, 26, "multiple-choice", "Choose the correct letter, A, B or C."), (27, 30, "matching-features", "Write the correct letter, A, B or C.")], [(31, 34, "multiple-choice", "Choose the correct letter, A, B or C."), (35, 40, "sentence-completion", "Complete the notes below.")]],
}
...
def emit_test(n: int) -> str:
    ...
    for section_index, nodes in enumerate(section_nodes(body), 1):
        ...
        parts.append({"label": f"Section {section_index}", "stimulus": {"kind": "audio", "label": f"Section {section_index}", "src": f"/audio/listening/test-{n:03d}.mp3", "questionHtml": semantic_question_html(nodes, metas, image_paths)}, "groups": [make_group(n, section_index, group_index, m, text) for group_index, m in enumerate(metas, 1)]})
