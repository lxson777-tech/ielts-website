...
out=Path('C:/Users/Alex/Desktop/Projects/IELTS website/.tmp/claude-review-2026-09-22')
with sync_playwright() as p:
    browser=p.chromium.launch(headless=True)
    page=browser.new_page(locale='en-US')
    page.goto('http://127.0.0.1:4347/ielts-website/trainers/focused/writing-lexical-topic-vocabulary-check',wait_until='networkidle')
    ...
    out.joinpath('task2-browser-storage.json').write_text(json.dumps(data,indent=2),encoding='utf-8')
    events=[]
    ...
    page.screenshot(path=str(out/'task2-browser.png'),full_page=True)
    browser.close()
