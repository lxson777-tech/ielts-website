...
Run on 2026-09-24 against a DEV server at http://127.0.0.1:4382/ielts-website, with the free local
accounts stand-in (`node tools/mr-ez-dev-server.mjs`) at http://127.0.0.1:8829. Both were started for
...
|---|---|---|
| Student A signed up on the local stand-in | PASS | user id cc296b9f-6ce5-4316-a0d7-db142c9e65c8 |
...
_screenshot **final-f23-01-essay-grading-held-for-a.png**: url=`http://127.0.0.1:4382/ielts-website/trainers/writing?task=pte-wt-132-task2`, landmark heading="Writing Trainer"_
| B is signed in on the same page, never reloaded, while A's essay is still being graded | PASS | user id 717e22a0-bb75-40ce-8f8f-57339f484cac, menu identity 'synthetic-student-b-f23-005255@example.test', request still held: True, same page as the submission (no reload): True |

_screenshot **final-f23-02-essay-b-signed-in-while-grading.png**: url=`http://127.0.0.1:4382/ielts-website/trainers/writing?task=pte-wt-132-task2`, landmark heading="Writing Trainer"_
...
_screenshot **final-f23-03-essay-grade-arrived-b-sees-notice.png**: url=`http://127.0.0.1:4382/ielts-website/trainers/writing?task=pte-wt-132-task2`, landmark heading="Writing Trainer"_
...
| Nothing of A's essay is under B, or under anybody but A, on this device | PASS | B's writing rows for the prompt: 0; B's record: []; keys carrying A's essay: ['ielts.progress.v1::u:cc296b9f-6ce5-4316-a0d7-db142c9e65c8'] |
| B's account on the stand-in received nothing of A's | PASS | B's user_state carries A's essay: False; B's events: [] |
| A signs back in and finds the essay in their own writing history | PASS | signed in as cc296b9f-6ce5-4316-a0d7-db142c9e65c8; history lists the prompt: True |

_screenshot **final-f23-04-essay-a-back-finds-it.png**: url=`http://127.0.0.1:4382/ielts-website/trainers/writing`, landmark heading="Writing Trainer"_
...
**Writing failed/4xx/5xx requests:** FAILED http://127.0.0.1:8829/auth/v1/logout?scope=global (net::ERR_ABORTED); FAILED http://127.0.0.1:8829/auth/v1/logout?scope=global (net::ERR_ABORTED)
...
| Student C signed up on the local stand-in | PASS | user id 6eeb5683-2909-408f-818a-e23a1ed176df |
| C's recorded answer went out for grading and is being held (nothing reached any grader) | PASS | held=1 |

_screenshot **final-f23-05-speaking-grading-held-for-c.png**: url=`http://127.0.0.1:4382/ielts-website/trainers/speaking?part=2&card=p2-journey`, landmark heading="Speaking Trainer"_
| D is signed in on the same page, never reloaded, while C's answer is still being graded | PASS | user id ac48fba6-e9ee-4096-bedb-b0cd9f651728, request still held: True, same page (no reload): True |
...
_screenshot **final-f23-06-speaking-grade-arrived-d-sees-notice.png**: url=`http://127.0.0.1:4382/ielts-website/trainers/speaking?part=2&card=p2-journey`, landmark heading="Speaking Trainer"_
...
| C signs back in and the grade reaches C's own account on the stand-in | PASS | signed in as 6eeb5683-2909-408f-818a-e23a1ed176df; C's events: ['speak:p2-journey']; C's user_state carries the cue card: True |

_screenshot **final-f23-07-speaking-c-back-account.png**: url=`http://127.0.0.1:4382/ielts-website/account`, landmark heading="Account & progress"_

**Speaking failed/4xx/5xx requests:** FAILED http://127.0.0.1:8829/auth/v1/logout?scope=global (net::ERR_ABORTED); FAILED http://127.0.0.1:8829/auth/v1/logout?scope=global (net::ERR_ABORTED)
...
| Check | Result | Observed |
|---|---|---|
| Student E signed up on the local stand-in | PASS | user id a37ed060-c47d-4c1e-9aa0-4d2458d45ae2 |
| E's essay is on screen and kept as E's own draft | PASS | ielts.writing.draft.v1::u:a37ed060-c47d-4c1e-9aa0-4d2458d45ae2::pte-wt-132-task2 carries E's essay: True |

_screenshot **final-f23-08-editor-e-typing.png**: url=`http://127.0.0.1:4382/ielts-website/trainers/writing?task=pte-wt-132-task2`, landmark heading="Writing Trainer"_
...
| F signs up in the second tab: the first tab's editor is F's now, empty, with the note, never reloaded | PASS | user id c1613f6d-7b92-43bb-b8c9-cf30b3d110bd; text box empty: True; note shown: True; E's essay anywhere on the page: False; same page: True |
...
_screenshot **final-f23-09-editor-f-empty-after-switch.png**: url=`http://127.0.0.1:4382/ielts-website/trainers/writing?task=pte-wt-132-task2`, landmark heading="Writing Trainer"_
...
| E's essay is still in E's own draft, and in no other key on this device | PASS | keys carrying E's essay: ['ielts.writing.draft.v1::u:a37ed060-c47d-4c1e-9aa0-4d2458d45ae2::pte-wt-132-task2'] |
| F types an essay of their own in the first tab, and it is kept as F's own draft | PASS | ielts.writing.draft.v1::u:c1613f6d-7b92-43bb-b8c9-cf30b3d110bd::pte-wt-132-task2 carries F's essay: True, E's: False |
| E signs back in (second tab): the first tab's editor shows E's own draft again, never reloaded | PASS | signed in as a37ed060-c47d-4c1e-9aa0-4d2458d45ae2; E's essay in the text box: True; F's: False; same page: True |
| F's essay stays in F's own draft, untouched by E's return | PASS | keys carrying F's essay: ['ielts.writing.draft.v1::u:c1613f6d-7b92-43bb-b8c9-cf30b3d110bd::pte-wt-132-task2'] |

_screenshot **final-f23-10-editor-e-back-finds-draft.png**: url=`http://127.0.0.1:4382/ielts-website/trainers/writing?task=pte-wt-132-task2`, landmark heading="Writing Trainer"_
...
_screenshot **final-f23-11-editor-e-report.png**: url=`http://127.0.0.1:4382/ielts-website/trainers/writing?task=pte-wt-132-task2`, landmark heading="Writing Trainer"_
...
| E's latest text, typed just before the switch, is saved under E | PASS | ielts.writing.draft.v1::u:a37ed060-c47d-4c1e-9aa0-4d2458d45ae2::pte-wt-132-task2 carries the latest text: True |
| Nothing of it is saved under the signed-out device owner or anybody else, even after the wait ran out | PASS | keys carrying E's text: ['ielts.writing.draft.v1::u:a37ed060-c47d-4c1e-9aa0-4d2458d45ae2::pte-wt-132-task2']; draft keys for this task: ['ielts.writing.draft.v1::u:a37ed060-c47d-4c1e-9aa0-4d2458d45ae2::pte-wt-132-task2', 'ielts.writing.draft.v1::u:c1613f6d-7b92-43bb-b8c9-cf30b3d110bd::pte-wt-132-task2'] |
...
_screenshot **final-f23-12-debounce-switched-mid-wait.png**: url=`http://127.0.0.1:4382/ielts-website/trainers/writing?task=pte-wt-132-task2`, landmark heading="Writing Trainer"_
...
_screenshot **final-f23-13-debounce-e-back-latest-text.png**: url=`http://127.0.0.1:4382/ielts-website/trainers/writing?task=pte-wt-132-task2`, landmark heading="Writing Trainer"_
...
**Editor, second tab failed/4xx/5xx requests:** FAILED http://127.0.0.1:8829/auth/v1/logout?scope=global (net::ERR_ABORTED); FAILED http://127.0.0.1:8829/auth/v1/logout?scope=global (net::ERR_ABORTED); FAILED http://127.0.0.1:8829/auth/v1/logout?scope=global (net::ERR_ABORTED)
...
| Check | Result | Observed |
|---|---|---|
| Student G signed up on the local stand-in | PASS | user id 7baa098e-5a3d-446f-a9ce-07938c7414a8 |
| G's grading request went out and is being held (nothing reached any grader) | PASS | held=1; request carries G's essay: True |

_screenshot **final-f23-14-revision-g-grading-held.png**: url=`http://127.0.0.1:4382/ielts-website/trainers/writing?task=pte-wt-132-task2`, landmark heading="Writing Trainer"_
| G signs out and back in on the same page: the submitted essay is back in G's editor, grade still held | PASS | signed in as 7baa098e-5a3d-446f-a9ce-07938c7414a8; essay in the text box: True; request still held: True; same page (no reload): True |
| G revises the essay and the revision autosaves as G's draft | PASS | ielts.writing.draft.v1::u:7baa098e-5a3d-446f-a9ce-07938c7414a8::pte-wt-132-task2 carries the revision: True |

_screenshot **final-f23-15-revision-g-revised-while-grading.png**: url=`http://127.0.0.1:4382/ielts-website/trainers/writing?task=pte-wt-132-task2`, landmark heading="Writing Trainer"_
...
| G's draft still holds the revision after the earlier grade was kept (before the fix it was deleted here) | PASS | ielts.writing.draft.v1::u:7baa098e-5a3d-446f-a9ce-07938c7414a8::pte-wt-132-task2 carries the revision: True; revision in the text box: True |

_screenshot **final-f23-16-revision-grade-arrived-revision-kept.png**: url=`http://127.0.0.1:4382/ielts-website/trainers/writing?task=pte-wt-132-task2`, landmark heading="Writing Trainer"_
...
_screenshot **final-f23-17-revision-after-reload.png**: url=`http://127.0.0.1:4382/ielts-website/trainers/writing?task=pte-wt-132-task2`, landmark heading="Writing Trainer"_
...
**Revision failed/4xx/5xx requests:** FAILED http://127.0.0.1:8829/auth/v1/logout?scope=global (net::ERR_ABORTED)
...
| Check | Result | Observed |
|---|---|---|
| Student H signed up on the local stand-in | PASS | user id cf89d6ad-24ae-439a-a230-0691e4dc209d |
...
_screenshot **final-f23-18-speaking-h-recording-question-2.png**: url=`http://127.0.0.1:4382/ielts-website/trainers/speaking?part=1&topic=p1-work`, landmark heading="Speaking Trainer"_
| H signs out in the second tab: the first tab's recording stops and its microphone is released at once | PASS | recording now: 0; live microphone tracks: 0; recorder told to stop 35 ms after the sign-out click (the other tab hears of it through the browser's shared storage); same page (no reload): True |
...
_screenshot **final-f23-19-speaking-stopped-at-switch.png**: url=`http://127.0.0.1:4382/ielts-website/trainers/speaking?part=1&topic=p1-work`, landmark heading="Speaking Trainer"_
| I signs up in the second tab: the first tab shows I no attempt and no way to answer H's remaining questions | PASS | user id b142d91c-42bd-4656-a0b1-a2ff88176ae0; question 2 or 3 on screen: False; recording now: 0; live microphone tracks: 0; same page: True |

_screenshot **final-f23-20-speaking-i-sees-no-attempt.png**: url=`http://127.0.0.1:4382/ielts-website/trainers/speaking?part=1&topic=p1-work`, landmark heading="Speaking Trainer"_
...
| H signs back in (second tab): the stopped attempt does not come back to life, and nothing records | PASS | signed in as cf89d6ad-24ae-439a-a230-0691e4dc209d; question 2 on screen: False; recording now: 0; grading requests: 0; same page (no reload): True |

**Speaking switch, first tab:** no console errors, no failed/4xx/5xx requests.

**Speaking switch, second tab failed/4xx/5xx requests:** FAILED http://127.0.0.1:8829/auth/v1/logout?scope=global (net::ERR_ABORTED); FAILED http://127.0.0.1:8829/auth/v1/logout?scope=global (net::ERR_ABORTED)

**Totals:** 56 PASS, 0 FAIL.

**A second run of this script, appended:** sections 7, 8, 9, against a fresh start of the dev server at http://127.0.0.1:4382/ielts-website with the live examiner address set to the intercepted path.
...
| Check | Result | Observed |
|---|---|---|
| Student J signed up on the local stand-in | PASS | user id 0f0ebcd2-7813-406f-82f1-036d3b6a57c0 |
...
_screenshot **final-f23-21-examiner-mock-microphone-pending.png**: url=`http://127.0.0.1:4382/ielts-website/tests/mock`, landmark heading="None"_
...
_screenshot **final-f23-22-examiner-mock-stopped-microphone-pending.png**: url=`http://127.0.0.1:4382/ielts-website/tests/mock`, landmark heading="You signed out during this mock exam"_
| (a) Student K signs up in the second tab while J's microphone request is still unanswered | PASS | user id f78506e8-1ca2-4782-9301-33f0ad32a1ab; held microphone requests: 1 |
...
_screenshot **final-f23-23-examiner-mock-after-late-microphone.png**: url=`http://127.0.0.1:4382/ielts-website/tests/mock`, landmark heading="This mock exam belongs to another student"_
| (a) J signs back in: the first tab is back on the Speaking brief with the interview marked interrupted (the mock's own suspension, unchanged), and nothing is recording | PASS | signed in as 0f0ebcd2-7813-406f-82f1-036d3b6a57c0; brief shown: True; interrupted note: True; microphone requests 1, held 0; tracks handed back 1, still live 0; recorders started 0, still recording 0; peer connections made 0, still open 0; sockets other than the dev server's own live-reload one 0; same page: True |

_screenshot **final-f23-24-examiner-mock-back-on-brief.png**: url=`http://127.0.0.1:4382/ielts-website/tests/mock`, landmark heading="Speaking"_
...
_screenshot **final-f23-25-examiner-mock-session-request-held.png**: url=`http://127.0.0.1:4382/ielts-website/tests/mock`, landmark heading="None"_
...
_screenshot **final-f23-26-examiner-mock-after-refused-request.png**: url=`http://127.0.0.1:4382/ielts-website/tests/mock`, landmark heading="You signed out during this mock exam"_
...
**Examiner (mock), first tab failed/4xx/5xx requests:** 503 http://127.0.0.1:8829/SYNTHETIC-intercepted-live-examiner/

**Examiner (mock), second tab failed/4xx/5xx requests:** FAILED http://127.0.0.1:8829/auth/v1/logout?scope=global (net::ERR_ABORTED); FAILED http://127.0.0.1:8829/auth/v1/logout?scope=global (net::ERR_ABORTED); FAILED http://127.0.0.1:8829/auth/v1/logout?scope=global (net::ERR_ABORTED)
| (c) Student L opens the standalone examiner, signed in; Start is enabled (the settings answered by the intercept) | PASS | user id 78e3bd9f-b307-41e7-81ce-509b06b6ec7c; Start enabled: True; settings requests answered: 1 |
...
_screenshot **final-f23-27-examiner-standalone-after-late-microphone.png**: url=`http://127.0.0.1:4382/ielts-website/speaking/examiner`, landmark heading="None"_

**Examiner (standalone), first tab:** no console errors, no failed/4xx/5xx requests.

**Examiner (standalone), second tab failed/4xx/5xx requests:** FAILED http://127.0.0.1:8829/auth/v1/logout?scope=global (net::ERR_ABORTED)
...
| Check | Result | Observed |
|---|---|---|
| Student N signed up on the local stand-in | PASS | user id cb80ad17-2404-4573-8c39-b82a9fdf8c30 |
...
_screenshot **final-f23-28-link-mock-offer-held.png**: url=`http://127.0.0.1:4382/ielts-website/tests/mock`, landmark heading="None"_
...
| (a) Student O signs up in the second tab while N's offer is still held | PASS | user id 0e627381-ce4d-43d0-8e8f-b132ca446b7d; held offers: 1 |
...
_screenshot **final-f23-32-link-gemini-after-token.png**: url=`http://127.0.0.1:4382/ielts-website/speaking/examiner`, landmark heading="None"_

**Connection setup (Gemini rollback), first tab:** no console errors, no failed/4xx/5xx requests.

**Connection setup (Gemini rollback), second tab failed/4xx/5xx requests:** FAILED http://127.0.0.1:8829/auth/v1/logout?scope=global (net::ERR_ABORTED)
