...
**This is a RERUN** (results-login-rework-f20.md, screenshots prefixed "login-f20-") after a fix round on top of the run recorded in results.md. results.md is left untouched.
...
**This run is against the FREE LOCAL STAND-IN** (`node tools/mr-ez-dev-server.mjs`, in-memory, this machine only), site under test at http://127.0.0.1:4472/ielts-website, stand-in REST surface at http://127.0.0.1:8811. It is NOT a real Supabase project, and nothing below is claimed as proof against one. Every student, email and piece of work is SYNTHETIC.
...
_screenshot **login-f20-01-signed-out-lesson-studied.png**: url=`http://127.0.0.1:4472/ielts-website/lessons/reading/headings`, landmark heading="Matching Headings"_
| Signed out: a short reading drill can be sat and submitted | PASS | 9 answer control(s) filled, submitted=True, landed on http://127.0.0.1:4472/ielts-website/trainers/reading/reading-full-006-drill-p2 |

_screenshot **login-f20-02-signed-out-drill-submitted.png**: url=`http://127.0.0.1:4472/ielts-website/trainers/reading/reading-full-006-drill-p2`, landmark heading="None"_
| Signed out: the plan can be saved with a target band through the intake | PASS | Save my plan clicked = True, landed on http://127.0.0.1:4472/ielts-website/dashboard |

_screenshot **login-f20-03-signed-out-plan-saved.png**: url=`http://127.0.0.1:4472/ielts-website/dashboard`, landmark heading="Good evening.
A little practice. A step closer."_

**localStorage after step 1 (signed out), owner = "anon:5192388e-7150-4540-b20c-1268c587175c":** ['ielts.device.v1', 'ielts.learning.legacy.adopted.v1', 'ielts.learning.legacy.v1', 'ielts.learning.plan.v1::anon:5192388e-7150-4540-b20c-1268c587175c', 'ielts.learning.record.v1::anon:5192388e-7150-4540-b20c-1268c587175c', 'ielts.progress.v1::anon:5192388e-7150-4540-b20c-1268c587175c', 'ielts.studyplan.v1::anon:5192388e-7150-4540-b20c-1268c587175c', 'ielts.unowned.adopted.v1']
| The work just done is stored under this device's own anonymous owner | PASS | owner_namespace() = "anon:5192388e-7150-4540-b20c-1268c587175c" |
...
| Check | Result | Observed |
|---|---|---|
| Signing up went /sign-up, then /profile, then back to the page it started on | PASS | user id 2d4ff546-0c79-4832-a229-363f5b2916d0, landed on /dashboard |
| A's profile (a synthetic adult) reached the stand-in's student_profiles under A's id | PASS | [{"user_id": "2d4ff546-0c79-4832-a229-363f5b2916d0", "first_name": "Synthetic", "last_name": "Student", "date_of_birth": "2000-03-04", "phone": "+77012345678", "city": "Almaty", "occupation": "Synthetic University", "source": "friend", "parent_name": null, "parent_phone": null, "parent_consent_at": null, "created_at": "2026-09-24T13:34:44.413Z", "updated_at": "2026-09-24T13:34:44.413Z"}] |
| After signing in as A, the workspace menu shows Sign out, not Sign in | PASS | {"shows_sign_in": false, "shows_sign_out": true, "identity": "synthetic-student-a-f20@example.test", "name": "Synthetic Student"} |
| The menu calls A by name, with the email underneath | PASS | {"shows_sign_in": false, "shows_sign_out": true, "identity": "synthetic-student-a-f20@example.test", "name": "Synthetic Student"} |

_screenshot **login-f20-04-a-signed-in-workspace-menu.png**: url=`http://127.0.0.1:4472/ielts-website/dashboard`, landmark heading="Good evening.
A little practice. A step closer."_
...
_screenshot **login-f20-04b-a-signed-in-offer-shown.png**: url=`http://127.0.0.1:4472/ielts-website/dashboard`, landmark heading="Good evening.
A little practice. A step closer."_

**Student A's real user id, captured straight off the /auth/v1/signup response = "2d4ff546-0c79-4832-a229-363f5b2916d0"** (not guessed from a localStorage owner key - owner_namespace() prefers an anon: key whenever one exists, which would be wrong here since the device's anonymous record is still present).
...
_screenshot **login-f20-04c-a-accepted-confirmation.png**: url=`http://127.0.0.1:4472/ielts-website/dashboard`, landmark heading="Good evening.
A little practice. A step closer."_
...
_screenshot **login-f20-05-a-today-shows-nothing-from-before-sign-in-desktop.png**: url=`http://127.0.0.1:4472/ielts-website/dashboard`, landmark heading="Good evening.
A little practice. A step closer."_

_screenshot **login-f20-05-a-today-shows-nothing-from-before-sign-in-phone.png**: url=`http://127.0.0.1:4472/ielts-website/dashboard`, landmark heading="Good evening.
A little practice. A step closer."_
...
_screenshot **login-f20-05b-a-library-shows-claimed-lesson.png**: url=`http://127.0.0.1:4472/ielts-website/dashboard`, landmark heading="Good evening.
A little practice. A step closer."_
...
```json
{
  "user_state": [
    {
      "user_id": "2d4ff546-0c79-4832-a229-363f5b2916d0",
      "progress": {
        "version": 1,
        "lessons": {
          "reading-headings": {
            "completedAt": "2026-09-24T13:34:26.918Z"
          }
        },
        "tests": {
          "reading-full-006-drill-p2": [
            {
              "at": "2026-09-24T13:34:34.049Z",
              "raw": 0,
              "total": 13,
              "band": 0,
              "bandLabel": "below 2.5",
      ...
      "study_plan": {
        "done": [],
        "testDate": "",
        "createdAt": "2026-09-24T13:34:48.582Z",
        "targetBand": "7.0",
  ...
  "learning_plan": [
    {
      ...
      "plan": {
        ...
        "confirmed": false,
        "createdAt": "2026-09-24T13:34:43.640Z",
        "updatedAt": "2026-09-24T13:34:48.582Z",
        "goals": {
          "overallTarget": null,
          "perPaperMinimums": {},
          "examDate": null,
...
```
| The claimed lesson reached the stand-in under A's own id (not just the browser's own copy) | PASS | 2 learning_events row(s) uploaded for A after the claim: [{"user_id": "2d4ff546-0c79-4832-a229-363f5b2916d0", "event_id": "ev:0f55bcc156ed979f14fbe18a84ef06f0", "event": {"id": "ev:0f55bcc156ed979f14fbe18a84ef06f0", "activityId": "lesson:reading-headings", "contentVersion": 0, "at": "2026-09-24T13:34:26.918Z", "localDate": "2026-09-24", "subskill": "exam-format", "mode": "practice", "completion": "completed", "assistance": "none", "seenBefore": false, "outcome": {"kind": "studied", "estimatedMinutes": 14}, "provenance": "recorded"}, "occurred_at": "2026-09-24T13:34:26.918Z", "activity_id": "lesson:reading-headings", "paper": null, "mode": "practice" |
...
_screenshot **login-f20-06-a-signed-in-lesson-studied.png**: url=`http://127.0.0.1:4472/ielts-website/lessons/reading/tfng`, landmark heading="True / False / Not Given"_

_screenshot **login-f20-07-a-report-with-signed-in-work.png**: url=`http://127.0.0.1:4472/ielts-website/report`, landmark heading="Your progress, one page."_

_screenshot **login-f20-08-a-account-with-signed-in-work.png**: url=`http://127.0.0.1:4472/ielts-website/account`, landmark heading="Account & progress"_
  ...
  "user_state": [
    {
      ...
      "progress": {
        ...
        "lessons": {
          ...
          "reading-tfng": {
            "completedAt": "2026-09-24T13:34:53.317Z"
          }
        },
        "tests": {
          "reading-full-006-drill-p2": [
  ...
  "learning_plan": [
    {
      ...
      "plan": {
        ...
        "activeSession": {
          "id": "sess:4325cd58196322767a52c25e84cb5a8d",
          "date": "2026-09-24",
          ...
          "steps": [
            {
              "stepId": "sess:4325cd58196322767a52c25e84cb5a8d:1:teach",
              "role": "teach",
            ...
            {
              "stepId": "sess:4325cd58196322767a52c25e84cb5a8d:2:teach",
              "role": "teach",
...
```
| The lesson marked while signed in reached the stand-in under A's own id | PASS | 3 learning_events row(s) uploaded for A: [{"user_id": "2d4ff546-0c79-4832-a229-363f5b2916d0", "event_id": "ev:0f55bcc156ed979f14fbe18a84ef06f0", "event": {"id": "ev:0f55bcc156ed979f14fbe18a84ef06f0", "activityId": "lesson:reading-headings", "contentVersion": 0, "at": "2026-09-24T13:34:26.918Z", "localDate": "2026-09-24", "subskill": "exam-format", "mode": "practice", "completion": "completed", "assistance": "none", "seenBefore": false, "outcome": {"kind": "studied", "estimatedMinutes": 14}, "provenance": "recorded"}, "occurred_at": "2026-09-24T13:34:26.918Z", "activity_id": "lesson:reading-headings", "paper": null, "mode": "practice", "created_at": "2026-09-24T13:34:49.740Z"}, {"user_id": "2d4ff546-0c79-4832-a229-363f5b2916d0", "event_id": "ev:24d99fb4fb50ba003228df748f890e4d", "event": {"id": "ev:24d99fb4fb50ba003228df748f890e4d |
| After sign-out, the workspace menu shows Sign in, not Sign out | PASS | {"shows_sign_in": true, "shows_sign_out": false, "identity": null, "name": null} |

_screenshot **login-f20-09-signed-out-after-a.png**: url=`http://127.0.0.1:4472/ielts-website/account`, landmark heading="Account & progress"_
...
_screenshot **login-f20-10-signed-out-today-shows-device-anon-session.png**: url=`http://127.0.0.1:4472/ielts-website/dashboard`, landmark heading="Good evening.
A little practice. A step closer."_
...
_screenshot **login-f20-11-signed-out-account-shows-device-history-only.png**: url=`http://127.0.0.1:4472/ielts-website/account`, landmark heading="Account & progress"_
...
| Check | Result | Observed |
|---|---|---|
| B (a synthetic student under 18) saved a profile with a parent's name, phone and agreement | PASS | [{"user_id": "cb28e474-099a-4482-bf69-848cbdc7f28b", "first_name": "Synthetic", "last_name": "Younger", "date_of_birth": "2012-09-01", "phone": "+77020001122", "city": "Almaty", "occupation": "Synthetic School 1", "source": "centre", "parent_name": "Synthetic Parent", "parent_phone": "+77770003344", "parent_consent_at": "2026-09-24T13:35:17.333Z", "created_at": "2026-09-24T13:35:17.343Z", "updated_at": "2026-09-24T13:35:17.343Z"}] |
...
_screenshot **login-f20-12-b-signed-in-no-offer.png**: url=`http://127.0.0.1:4472/ielts-website/account`, landmark heading="Account & progress"_
| B's Today is an empty intake, not A's session | PASS | .today-intake=1, .today-active=0 |

_screenshot **login-f20-13-b-today-empty-intake.png**: url=`http://127.0.0.1:4472/ielts-website/dashboard`, landmark heading="Good evening.
A little practice. A step closer."_
| B's history is empty | PASS | 0 row(s) in the Reading score-history table |

_screenshot **login-f20-14-b-account-empty.png**: url=`http://127.0.0.1:4472/ielts-website/account`, landmark heading="Account & progress"_

**Student B's real user id, captured straight off the /auth/v1/signup response = "cb28e474-099a-4482-bf69-848cbdc7f28b"**
...
```json
{
  "user_state": [
    {
      "user_id": "cb28e474-099a-4482-bf69-848cbdc7f28b",
      "progress": {
        "version": 1,
        "lessons": {},
        "tests": {},
      ...
      "study_plan": {
        "done": [],
        "testDate": "",
        "createdAt": "2026-09-24T13:35:20.522Z",
        "targetBand": "7.0",
        "startDate": "2026-09-24",
        "dailyMinutes": 25,
        "studyDays": "daily",
  ...
  "learning_plan": [
    {
      ...
      "plan": {
        ...
        "status": "provisional-no-date",
        "confirmed": false,
        "createdAt": "2026-09-24T13:35:15.069Z",
        "updatedAt": "2026-09-24T13:35:15.069Z",
        "goals": {
          "overallTarget": null,
          "perPaperMinimums": {},
          "examDate": null,
        ...
        "activeSession": {
          ...
          "steps": [
            ...
            {
              "stepId": "sess:4325cd58196322767a52c25e84cb5a8d:3:practise",
              "role": "practise",
            ...
            {
              "stepId": "sess:4325cd58196322767a52c25e84cb5a8d:4:independent-check",
              "role": "independent-check",
              "activityId": "check:practice-reading-sentence",
              "contentVersion": 1,
              "minutes": 5,
            ...
            {
              "stepId": "sess:4325cd58196322767a52c25e84cb5a8d:5:assess",
              "role": "assess",
              "activityId": "check:practice-listening-map-labelling",
              "contentVersion": 1,
              "minutes": 4,
              "purpose": "A short sample to find out where you are. It is too short to be a band
```
...
| Check | Result | Observed |
|---|---|---|
| The workspace menu shows A signed in again | PASS | {"shows_sign_in": false, "shows_sign_out": true, "identity": "synthetic-student-a-f20@example.test", "name": "Synthetic Student"} |
...
_screenshot **login-f20-15-a-restored-today-desktop.png**: url=`http://127.0.0.1:4472/ielts-website/dashboard`, landmark heading="Good evening.
A little practice. A step closer."_

_screenshot **login-f20-15-a-restored-today-phone.png**: url=`http://127.0.0.1:4472/ielts-website/dashboard`, landmark heading="Good evening.
A little practice. A step closer."_
  ...
  "user_state": [
    {
      ...
      "study_plan": {
        "done": [],
        "testDate": "",
        "createdAt": "2026-09-24T13:35:29.037Z",
        "targetBand": "7.0",
        "startDate": "2026-09-24",
        "doneKeys": [],
        "dailyMinutes": 25,
  ...
  "learning_plan": [
    {
      ...
      "plan": {
        ...
        "status": "provisional-no-date",
        "confirmed": false,
        "createdAt": "2026-09-24T13:35:28.999Z",
        "updatedAt": "2026-09-24T13:35:29.037Z",
        "goals": {
          "overallTarget": {
            "band": 7,
            "status": "provisional"
...
**Steps 2-5 failed/4xx/5xx requests:** FAILED http://127.0.0.1:8811/auth/v1/logout?scope=local (net::ERR_ABORTED); FAILED http://127.0.0.1:8811/auth/v1/logout?scope=local (net::ERR_ABORTED)
...
_screenshot **login-f20-16-device2-signed-out-lesson.png**: url=`http://127.0.0.1:4472/ielts-website/lessons/reading/ynng`, landmark heading="Yes / No / Not Given"_

**Device 2's anonymous record, right after the signed-out lesson, before B signs in:** [{"id": "ev:822e59c48b3839bad3b5069a2c2486a0", "activityId": "lesson:reading-ynng", "paper": null, "completion": "completed"}]
...
_screenshot **login-f20-17-device2-b-signed-in-offer-shown.png**: url=`http://127.0.0.1:4472/ielts-website/dashboard`, landmark heading="Good evening.
A little practice. A step closer."_
...
_screenshot **login-f20-17b-device2-b-declined-confirmation.png**: url=`http://127.0.0.1:4472/ielts-website/dashboard`, landmark heading="Good evening.
A little practice. A step closer."_
  ...
  "user_state": [
    {
      ...
      "study_plan": {
        "done": [],
        "testDate": "",
        "createdAt": "2026-09-24T13:35:41.500Z",
        "targetBand": "7.0",
        "startDate": "2026-09-24",
        "doneKeys": [],
        "dailyMinutes": 25,
  ...
  "learning_plan": [
    {
      ...
      "plan": {
        ...
        "confirmed": false,
        "createdAt": "2026-09-24T13:35:41.500Z",
        "updatedAt": "2026-09-24T13:35:41.500Z",
        "goals": {
          "overallTarget": {
            "band": 7,
            "status": "provisional"
...
**Device 2's anonymous record after B signs out again:** [{"id": "ev:822e59c48b3839bad3b5069a2c2486a0", "activityId": "lesson:reading-ynng", "paper": null, "completion": "completed"}]
...
_screenshot **login-f20-18-device2-work-still-present-after-signout.png**: url=`http://127.0.0.1:4472/ielts-website/account`, landmark heading="Account & progress"_

**Step 6 failed/4xx/5xx requests:** FAILED http://127.0.0.1:8811/auth/v1/logout?scope=local (net::ERR_ABORTED)

**Run complete.** Every check above ran against the local stand-in (http://127.0.0.1:8811) and the site at http://127.0.0.1:4472/ielts-website, both started for this run and stopped afterwards. Nothing here is evidence against a real Supabase project.
