...
Run against the FROZEN PRODUCTION SNAPSHOT at http://localhost:4352/ielts-website on 2026-09-22.

**This is a RERUN** (results-account-journey-2.md, screenshots prefixed "account2-") after a fix round on top of the run recorded in results.md. results.md is left untouched.
...
_screenshot **account2-01-signed-out-lesson-studied.png**: url=`http://localhost:4352/ielts-website/lessons/reading/headings`, landmark heading="Matching Headings"_
...
_screenshot **account2-02-signed-out-drill-submitted.png**: url=`http://localhost:4352/ielts-website/trainers/reading/reading-full-006-drill-p2`, landmark heading="None"_
...
_screenshot **account2-03-signed-out-plan-saved.png**: url=`http://localhost:4352/ielts-website/dashboard`, landmark heading="Good morning.
A little practice. A step closer."_

**localStorage after step 1 (signed out), owner = "anon:326ea25c-3be2-498d-8603-1f8a38d40059":** ['ielts.device.v1', 'ielts.learning.legacy.adopted.v1', 'ielts.learning.legacy.v1', 'ielts.learning.plan.v1::anon:326ea25c-3be2-498d-8603-1f8a38d40059', 'ielts.learning.record.v1::anon:326ea25c-3be2-498d-8603-1f8a38d40059', 'ielts.progress.v1::anon:326ea25c-3be2-498d-8603-1f8a38d40059', 'ielts.studyplan.v1::anon:326ea25c-3be2-498d-8603-1f8a38d40059']
| The work just done is stored under this device's own anonymous owner | PASS | owner_namespace() = "anon:326ea25c-3be2-498d-8603-1f8a38d40059" |
...
_screenshot **account2-04-a-signed-in-workspace-menu.png**: url=`http://localhost:4352/ielts-website/dashboard`, landmark heading="Good morning.
A little practice. A step closer."_
| The "Work saved on this device" offer is shown after signing in as A on /dashboard | PASS | FIXED 22 September 2026: AnonymousWorkClaim now mounts as a card at the top of Today (src/components/learning/today/TodaySession.tsx), so it is reachable on the one screen every signed-in student lands on. Offer summary: 1 lesson studied \| 2 practice attempts \| 1 test attempt \| Your target band and exam date |

_screenshot **account2-04b-a-signed-in-offer-shown.png**: url=`http://localhost:4352/ielts-website/dashboard`, landmark heading="Good morning.
A little practice. A step closer."_

**Student A's real user id, captured straight off the /auth/v1/signup response = "4cd3db4d-849b-4c3a-a7e2-be78e0134ef2"** (not guessed from a localStorage owner key - owner_namespace() prefers an anon: key whenever one exists, which would be wrong here since the device's anonymous record is still present).
...
_screenshot **account2-04c-a-accepted-confirmation.png**: url=`http://localhost:4352/ielts-website/dashboard`, landmark heading="Good morning.
A little practice. A step closer."_
...
_screenshot **account2-05-a-today-shows-nothing-from-before-sign-in-desktop.png**: url=`http://localhost:4352/ielts-website/dashboard`, landmark heading="Good morning.
A little practice. A step closer."_

_screenshot **account2-05-a-today-shows-nothing-from-before-sign-in-phone.png**: url=`http://localhost:4352/ielts-website/dashboard`, landmark heading="None"_
| The claimed lesson (marked studied signed out in step 1) is in A's OWN learner record after accepting, not still parked under the device's anonymous owner | PASS | A's own record now holds 4 event(s): ["lesson:reading-headings", "lesson:reading-headings", "drill:reading-full-006-drill-p2", "trainer:reading"] |
...
_screenshot **account2-05b-a-library-shows-claimed-lesson.png**: url=`http://localhost:4352/ielts-website/dashboard`, landmark heading="Good morning.
A little practice. A step closer."_
...
```json
{
  "user_state": [
    {
      "user_id": "4cd3db4d-849b-4c3a-a7e2-be78e0134ef2",
      "progress": {
        "version": 1,
        "lessons": {
          "reading-headings": {
            "completedAt": "2026-09-22T19:02:00.188Z"
          }
        },
        "tests": {
          "reading-full-006-drill-p2": [
            {
              "at": "2026-09-22T19:02:08.135Z",
              "raw": 0,
              "total": 13,
              "band": 0,
              "bandLabel": "below 2.5",
      ...
      "study_plan": {
        "done": [],
        "testDate": "",
        "createdAt": "2026-09-22T19:02:39.854Z",
        "targetBand": "7.0",
  ...
  "learning_plan": [
    {
      ...
      "plan": {
        ...
        "confirmed": false,
        "createdAt": "2026-09-22T19:02:32.187Z",
        "updatedAt": "2026-09-22T19:02:39.854Z",
        "goals": {
          "overallTarget": {
            "band": 7,
            "status": "provisional"
...
```
| The claimed lesson reached the stand-in under A's own id (not just the browser's own copy) | PASS | 4 learning_events row(s) uploaded for A after the claim: [{"user_id": "4cd3db4d-849b-4c3a-a7e2-be78e0134ef2", "event_id": "ev:52d1e46cf8194a76d94d239759d6981a", "event": {"id": "ev:52d1e46cf8194a76d94d239759d6981a", "activityId": "lesson:reading-headings", "contentVersion": 0, "at": "2026-09-22T19:02:00.188Z", "localDate": "2026-09-23", "subskill": "exam-format", "mode": "practice", "completion": "completed", "assistance": "none", "seenBefore": false, "outcome": {"kind": "studied", "estimatedMinutes": 14}, "provenance": "recorded"}, "occurred_at": "2026-09-22T19:02:00.188Z", "activity_id": "lesson:reading-headings", "paper": null, "mode": "practice" |
...
_screenshot **account2-06-a-signed-in-lesson-studied.png**: url=`http://localhost:4352/ielts-website/lessons/reading/tfng`, landmark heading="True / False / Not Given"_

_screenshot **account2-07-a-report-with-signed-in-work.png**: url=`http://localhost:4352/ielts-website/report`, landmark heading="Your progress, one page."_

_screenshot **account2-08-a-account-with-signed-in-work.png**: url=`http://localhost:4352/ielts-website/account`, landmark heading="Account & progress"_
  ...
  "user_state": [
    {
      ...
      "progress": {
        ...
        "lessons": {
          ...
          "reading-tfng": {
            "completedAt": "2026-09-22T19:02:47.683Z"
          }
        },
        "tests": {
          "reading-full-006-drill-p2": [
  ...
  "learning_plan": [
    {
      ...
      "plan": {
        ...
        "activeSession": {
          ...
          "reason": "You answered 0 of 6 of these on your own across 1 sittings. That is below what Reading needs for your target, so it is the most useful hour you have.",
          "evidenceRefs": [
            {
              "kind": "estimate",
              "ref": "subskill:reading:sentence-completion",
              "evidence": "0 of 6 answered on your own across 1 sittings, most recently 0 days ago."
            },
            {
              "kind": "goal",
              "ref": "paper:reading",
          ...
          "steps": [
            ...
            },
            {
              ...
              "contentVersio
```
| The lesson marked while signed in reached the stand-in under A's own id | PASS | 5 learning_events row(s) uploaded for A: [{"user_id": "4cd3db4d-849b-4c3a-a7e2-be78e0134ef2", "event_id": "ev:52d1e46cf8194a76d94d239759d6981a", "event": {"id": "ev:52d1e46cf8194a76d94d239759d6981a", "activityId": "lesson:reading-headings", "contentVersion": 0, "at": "2026-09-22T19:02:00.188Z", "localDate": "2026-09-23", "subskill": "exam-format", "mode": "practice", "completion": "completed", "assistance": "none", "seenBefore": false, "outcome": {"kind": "studied", "estimatedMinutes": 14}, "provenance": "recorded"}, "occurred_at": "2026-09-22T19:02:00.188Z", "activity_id": "lesson:reading-headings", "paper": null, "mode": "practice", "created_at": "2026-09-22T19:02:42.062Z"}, {"user_id": "4cd3db4d-849b-4c3a-a7e2-be78e0134ef2", "event_id": "legacy:lesson:reading-headings", "event": {"id": "legacy:lesson:reading-headings", "activi |
| After sign-out, the workspace menu shows Sign in, not Sign out | PASS | {"shows_sign_in": true, "shows_sign_out": false, "identity": null} |

_screenshot **account2-09-signed-out-after-a.png**: url=`http://localhost:4352/ielts-website/account`, landmark heading="Account & progress"_
...
_screenshot **account2-10-signed-out-today-shows-device-anon-session.png**: url=`http://localhost:4352/ielts-website/dashboard`, landmark heading="Good morning.
A little practice. A step closer."_
...
_screenshot **account2-11-signed-out-account-shows-device-history-only.png**: url=`http://localhost:4352/ielts-website/account`, landmark heading="Account & progress"_
...
_screenshot **account2-12-b-signed-in-no-offer.png**: url=`http://localhost:4352/ielts-website/account`, landmark heading="Account & progress"_
| B's Today is an empty intake, not A's session | PASS | .today-intake=1, .today-active=0 |

_screenshot **account2-13-b-today-empty-intake.png**: url=`http://localhost:4352/ielts-website/dashboard`, landmark heading="Good morning.
A little practice. A step closer."_
| B's history is empty | PASS | 0 row(s) in the Reading score-history table |

_screenshot **account2-14-b-account-empty.png**: url=`http://localhost:4352/ielts-website/account`, landmark heading="Account & progress"_

**Student B's real user id, captured straight off the /auth/v1/signup response = "be4b3b90-a9a5-4328-804f-91761eaf1da9"**
...
```json
{
  "user_state": [
    {
      "user_id": "be4b3b90-a9a5-4328-804f-91761eaf1da9",
      "progress": {
        "version": 1,
        "lessons": {},
        "tests": {},
      ...
      "study_plan": {
        "done": [],
        "testDate": "",
        "createdAt": "2026-09-22T19:03:29.164Z",
        "targetBand": "7.0",
        "startDate": "2026-09-23",
        "dailyMinutes": 25,
        "studyDays": "daily",
  ...
  "learning_plan": [
    {
      ...
      "plan": {
        ...
        "status": "provisional-no-date",
        "confirmed": false,
        "createdAt": "2026-09-22T19:03:25.471Z",
        "updatedAt": "2026-09-22T19:03:25.471Z",
        "goals": {
          "overallTarget": null,
          "perPaperMinimums": {},
          "examDate": null,
...
_screenshot **account2-15-a-restored-today-desktop.png**: url=`http://localhost:4352/ielts-website/dashboard`, landmark heading="Good morning.
A little practice. A step closer."_

_screenshot **account2-15-a-restored-today-phone.png**: url=`http://localhost:4352/ielts-website/dashboard`, landmark heading="None"_
  ...
  "user_state": [
    {
      ...
      "study_plan": {
        "done": [],
        "testDate": "",
        "createdAt": "2026-09-22T19:03:48.738Z",
        "targetBand": "7.0",
        "startDate": "2026-09-23",
        "doneKeys": [],
        "dailyMinutes": 25,
  ...
  "learning_plan": [
    {
      ...
      "plan": {
        ...
        "status": "provisional-no-date",
        "confirmed": false,
        "createdAt": "2026-09-22T19:03:48.682Z",
        "updatedAt": "2026-09-22T19:03:48.738Z",
        "goals": {
          "overallTarget": {
            "band": 7,
            "status": "provisional"
        ...
        "activeSession": {
          ...
          "steps": [
            ...
            },
            {
              ...
              "contentVersio
```
| A's restored learning_events are the same rows as before B ever signed in | FAIL | 6 event row(s) for A at the end |

**Steps 2-5 failed/4xx/5xx requests:** FAILED http://127.0.0.1:8799/rest/v1/learning_events?user_id=eq.4cd3db4d-849b-4c3a-a7e2-be78e0134ef2&select=*&order=created_at.asc (net::ERR_ABORTED); FAILED http://localhost:4352/src/content/lesson-bodies/vocabulary-language.html?import&raw (net::ERR_ABORTED); FAILED http://localhost:4352/src/content/lesson-bodies/vocabulary-leisure.html?import&raw (net::ERR_ABORTED); FAILED http://localhost:4352/src/content/lesson-bodies/vocabulary-ai.html?import&raw (net::ERR_ABORTED); FAILED http://localhost:4352/src/content/lesson-bodies/vocabulary-ageing.html?import&raw (net::ERR_ABORTED); FAILED http://localhost:4352/src/data/tests/index.ts (net::ERR_ABORTED); FAILED http://localhost:4352/src/lib/tests/drills.ts (net::ERR_ABORTED); FAILED http://localhost:4352/src/content/lesson-bodies/vocabulary-social-media.html?import&raw (net::ERR_ABORTED); FAILED http://localhost:4352/src/content/lesson-bodies/vocabulary-family.html?import&raw (net::ERR_ABORTED); FAILED http://localhost:4352/src/content/lesson-bodies/vocabulary-housing.html?import&raw (net::ERR_ABORTED)
...
_screenshot **account2-16-device2-signed-out-lesson.png**: url=`http://localhost:4352/ielts-website/lessons/reading/ynng`, landmark heading="Yes / No / Not Given"_

**Device 2's anonymous record, right after the signed-out lesson, before B signs in:** [{"id": "ev:82fad3351348dc5643295ea1758ef250", "activityId": "lesson:reading-ynng", "paper": null, "completion": "completed"}, {"id": "legacy:lesson:reading-ynng", "activityId": "lesson:reading-ynng", "paper": "reading", "completion": "completed"}]
...
_screenshot **account2-17-device2-b-signed-in-offer-shown.png**: url=`http://localhost:4352/ielts-website/dashboard`, landmark heading="Good morning.
A little practice. A step closer."_
...
_screenshot **account2-17b-device2-b-declined-confirmation.png**: url=`http://localhost:4352/ielts-website/dashboard`, landmark heading="Good morning.
A little practice. A step closer."_
  ...
  "learning_plan": [
    {
      ...
      "plan": {
        ...
        "status": "provisional-no-date",
        "confirmed": false,
        "createdAt": "2026-09-22T19:04:16.036Z",
        "updatedAt": "2026-09-22T19:04:16.036Z",
        "goals": {
          "overallTarget": null,
          "perPaperMinimums": {},
          "examDate": null,
...
**Device 2's anonymous record after B signs out again:** [{"id": "ev:82fad3351348dc5643295ea1758ef250", "activityId": "lesson:reading-ynng", "paper": null, "completion": "completed"}, {"id": "legacy:lesson:reading-ynng", "activityId": "lesson:reading-ynng", "paper": "reading", "completion": "completed"}]
...
_screenshot **account2-18-device2-work-still-present-after-signout.png**: url=`http://localhost:4352/ielts-website/account`, landmark heading="Account & progress"_
