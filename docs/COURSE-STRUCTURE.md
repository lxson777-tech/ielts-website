...
1. Start speaking with confidence: overview, Part 1, vocabulary overview, family, education, work.
2. Listen for everyday information: overview, Part 1, completion questions, Part 2, maps, travel.
3. Read for meaning and detail: overview, paraphrase, short answers and completion questions, health and environment.
4. Build a clear Task 1 report: writing overview, method, linking words, charts, processes, housing and maps.
5. Develop and support ideas: Speaking Part 2, Task 2 method, opinion essays, Reading multiple choice and true/false/yes/no questions, technology and social media.
6. Follow and compare arguments: Listening Parts 3 and 4, multiple choice and matching, discussion and advantages essays, society and crime.
7. Handle complex questions: Reading matching types, remaining essay types, Speaking Part 3, government and AI vocabulary.
8. Exam conditions: full Reading and Listening tests, review, a complete mock, then two light study days.

## Source and preservation

`src/lib/course.ts` explicitly places each registry lesson in COURSE_UNITS. Titles, descriptions, duration estimates and URLs still come from their registries. All 49 part lessons and five existing overviews remain. No lesson bodies or questions are removed. Completion keys are unchanged. The course builder rejects missing or duplicate entries so adding content requires a deliberate placement.
