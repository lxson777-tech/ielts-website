...
export default function StrategyPanel({ skill, type }: { skill: TestSkill; type: QuestionType }) {
  // 'strategies' is a lazily loaded dictionary part (src/lib/i18n/dict/parts.ts):
  // this advice is roughly 20 KB of text and only the trainers show it, so it
  // is not in the chunk every Russian page downloads. Until it lands the
  // English shows, which is what it would show anyway.
