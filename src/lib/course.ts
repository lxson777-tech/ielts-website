...
export const COURSE_UNITS: { name: string; blurb: string; stage: Stage; keys: string[] }[] = [
  { name: 'Start speaking with confidence', stage: 1,
    ...
    keys: ['speaking', 'speaking-part1', 'vocabulary', 'vocabulary-family', 'vocabulary-education', 'vocabulary-work', 'vocabulary-leisure'] },
  { name: 'Listen for everyday information', stage: 1,
    ...
    keys: ['listening', 'listening-part1', 'listening-form-completion', 'listening-short-answer', 'listening-sentence-completion', 'listening-part2', 'listening-map-labelling', 'vocabulary-travel', 'vocabulary-transport'] },
  { name: 'Read for meaning and detail', stage: 2,
    ...
    keys: ['reading-task1', 'reading-paraphrase', 'reading-short-answer', 'reading-sentence', 'reading-summary-completion', 'reading-diagram', 'vocabulary-health', 'vocabulary-food', 'vocabulary-environment'] },
  { name: 'Build a clear Task 1 report', stage: 2,
    ...
    keys: ['writing', 'writing-method', 'vocabulary-conjunctions', 'writing-charts', 'writing-process', 'vocabulary-housing', 'writing-maps', 'vocabulary-sport'] },
  { name: 'Develop and support your ideas', stage: 2,
    ...
    keys: ['speaking-part2', 'writing-task2-method', 'writing-opinion', 'vocabulary-technology', 'reading-mc', 'reading-tfng', 'reading-ynng', 'vocabulary-social-media', 'vocabulary-media'] },
  { name: 'Follow and compare arguments', stage: 3,
    ...
    keys: ['listening-part3', 'listening-multiple-choice', 'listening-matching', 'listening-part4', 'vocabulary-society', 'writing-discussion', 'writing-advantages', 'vocabulary-crime', 'vocabulary-money', 'vocabulary-language'] },
  { name: 'Handle complex questions', stage: 3,
    ...
    keys: ['reading-headings', 'reading-matching-information', 'reading-matching-features', 'reading-matching-sentence-endings', 'vocabulary-government', 'writing-problem', 'writing-twopart', 'vocabulary-ai', 'vocabulary-arts', 'vocabulary-science', 'vocabulary-animals', 'speaking-part3'] },
