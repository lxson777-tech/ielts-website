...
export const strings: Record<string, string> = {
  ...
  'I used what I already know about the topic': 'Использованы собственные знания по теме, а не текст',
  ...
  'I was not sure what the statement claims': 'Не было понятно, что именно утверждает высказывание',
  ...
  'I checked whether it was true, not what the writer thinks': 'Проверялось, правда ли это, а не то, что думает автор',
  ...
  'I chose the person mentioned first in the passage': 'Выбран человек, упомянутый в тексте первым',
  ...
  'I ruled out two options but guessed between the last two': 'Два варианта исключены, но между последними двумя пришлось угадывать',
  ...
  'I wrote a word that did not fit the gap grammatically': 'Написано слово, которое грамматически не подходило к пропуску',
  ...
  'I took the answer from the wrong part of the passage': 'Ответ взят не из той части текста',
  ...
  'I filled in the wrong row or column': 'Заполнена не та строка или колонка',
  ...
  'I was confident about one option but guessed the second': 'Была уверенность в одном варианте, но второй пришлось угадывать',
  ...
  'I found one correct point but missed where the second one was': 'Найден один верный пункт, но не найдено, где находится второй',
  ...
  'I chose the category mentioned first in the passage': 'Выбрана категория, упомянутая в тексте первой',
  ...
  /* sentence-endings */
  'I only checked that the grammar fit, not the meaning': 'Проверена только грамматика, но не смысл',
  ...
  'I matched it to the wrong part of the passage': 'Это сопоставлено не с той частью текста',
