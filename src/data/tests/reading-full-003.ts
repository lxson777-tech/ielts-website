  ...
  groups: [
    {
      ...
      questions: [
        { id: 'q1', textHtml: 'evidence that early farmers were less healthy than hunter-gatherers', answer: 'C' },
        { id: 'q2', textHtml: 'the idea that farming developed without anyone intending it', answer: 'D' },
        { id: 'q3', textHtml: 'how farming allowed people who did not grow food to exist', answer: 'E' },
        { id: 'q4', textHtml: 'examples of crops domesticated in different regions of the world', answer: 'B' },
        { id: 'q5', textHtml: 'the effect of farming on the plants and animals themselves', answer: 'F' },
      ],
    },
    {
      title: 'Questions 6–9',
      ...
      questions: [
        { id: 'q6', before: 'Farming began around', after: 'thousand years ago.', answer: 'twelve' },
        { id: 'q7', before: 'In the Fertile Crescent, people cultivated wild wheat and', after: '.', answer: 'barley' },
        { id: 'q8', before: 'In Central America, farmers domesticated maize, beans and', after: '.', answer: 'squash' },
        { id: 'q9', before: 'A farming surplus made possible the appearance of', after: 'such as potters and priests.', answer: 'specialists' },
      ],
    },
    {
      ...
      questions: [
        { id: 'q10', textHtml: 'Farming was invented in only one place and spread from there.', answer: 'False' },
        { id: 'q11', textHtml: 'Some experts think hunter-gatherers worked fewer hours than farmers.', answer: 'True' },
        { id: 'q12', textHtml: 'The end of the ice age made every region warmer and wetter.', answer: 'False' },
        { id: 'q13', textHtml: 'Modern maize is unable to spread its seeds without human help.', answer: 'True' },
      ],
    },
  ],
};
  ...
  groups: [
    {
      ...
      questions: [
        { id: 'q14', textHtml: 'Paragraph B', answer: 'i' },
        { id: 'q15', textHtml: 'Paragraph C', answer: 'iv' },
        { id: 'q16', textHtml: 'Paragraph D', answer: 'v' },
        { id: 'q17', textHtml: 'Paragraph E', answer: 'iii' },
        { id: 'q18', textHtml: 'Paragraph F', answer: 'vi' },
      ],
    },
    {
    ...
    },
    {
      ...
      questions: [
        { id: 'q24', textHtml: 'Shifting birds’ internal clocks with artificial light caused them to', options: ['stop flying altogether.', 'head in the wrong direction.', 'navigate more accurately.', 'ignore the sun.'], answer: 'B' },
        { id: 'q25', textHtml: 'In the planetarium experiments, birds oriented themselves by', options: ['a single bright star.', 'the moon.', 'the still point the northern stars turn around.', 'the edge of the dome.'], answer: 'C' },
        { id: 'q26', textHtml: 'When pigeons’ sense of smell was blocked, they', options: ['found their way home more easily.', 'became worse at finding home.', 'flew in circles.', 'relied only on the sun.'], answer: 'B' },
      ],
    },
  ],
};
  ...
  groups: [
    {
      ...
      questions: [
        { id: 'q27', textHtml: 'Money makes almost no difference to the happiness of the poor.', answer: 'No' },
        { id: 'q28', textHtml: 'How people spend money can matter more than how much they have.', answer: 'Yes' },
        { id: 'q29', textHtml: 'Governments should raise taxes on the wealthy.', answer: 'Not Given' },
        { id: 'q30', textHtml: 'Telling poor people that money is unimportant is misguided.', answer: 'Yes' },
        { id: 'q31', textHtml: 'Comparing ourselves with others can reduce our contentment.', answer: 'Yes' },
      ],
    },
    {
      ...
      questions: [
        { id: 'q32', textHtml: 'For people on very low incomes, more money is valuable because', answer: 'E' },
        { id: 'q33', textHtml: 'Once basic needs are met,', answer: 'A' },
        { id: 'q34', textHtml: 'The puzzle named after Easterlin is that', answer: 'B' },
        { id: 'q35', textHtml: 'When money is spent on experiences,', answer: 'C' },
        { id: 'q36', textHtml: 'When people spend money on others,', answer: 'D' },
      ],
    },
    {
      ...
      instructionHtml: 'Choose the correct letter, <strong>A</strong>, <strong>B</strong>, <strong>C</strong> or <strong>D</strong>.',
      questions: [
        { id: 'q37', textHtml: 'What does the writer say about the happiness curve as income rises?', options: ['It rises steadily without limit.', 'It eventually flattens out.', 'It falls at high incomes.', 'It never rises at all.'], answer: 'B' },
        { id: 'q38', textHtml: 'The process of “adaptation” explains why', options: ['experiences are quickly forgotten.', 'possessions stop giving pleasure.', 'the poor stay unhappy.', 'people give money away.'], answer: 'B' },
        { id: 'q39', textHtml: 'The experiments on spending money on others are notable because the effect', options: ['only worked with large sums.', 'appeared across different cultures.', 'disappeared over time.', 'applied only to rich people.'], answer: 'B' },
        { id: 'q40', textHtml: 'The main lesson of the final paragraph is that greater happiness comes from', options: ['earning as much as possible.', 'how money is used, not just how much there is.', 'avoiding all comparison with others.', 'never spending on possessions.'], answer: 'B' },
      ],
    },
  ],
};
