          ...
          "questions": [
            {
              ...
              "explanation": "Paragraph A names the Angles, Saxons and Jutes and their West Germanic dialects as the ancestors of English.",
              "evidence": "The Angles, Saxons, and Jutes brought with them dialects of the West Germanic family of languages, which are the ancestors of English."
            },
            {
              "id": "q2",
              "answer": "B",
              "textHtml": "an explanation of why a particular group of people did not contribute many words to the English language",
              "explanation": "Paragraph B explains the Vikings added few words because English already had words for the things they discussed.",
              "evidence": "Although the Vikings left their mark on the English language, they did not add many words to the English vocabulary because the English already had words for the things the Vikings discussed."
            },
            {
              "id": "q3",
              "answer": "D",
              "textHtml": "mention of a significant written piece that established English as a language worthy of formal expression",
              "explanation": "Paragraph D says Chaucer's Canterbury Tales proved English could be used for literary purposes, not just as a vulgar language.",
            ...
            },
            {
              ...
              "explanation": "Paragraph E says Caxton spelt the word book three different ways on the same page.",
              "evidence": "Caxton himself was inconsistent, spelling the word book in three different ways on the same page."
            },
            {
              "id": "q5",
              "answer": "C",
              "textHtml": "examples of words which English borrowed from French",
              "explanation": "Paragraph C gives crown, castle, court and other words that English borrowed from French.",
              "evidence": "The words crown, castle, court, parliament, army, and government all come from French, as do justice, crime, prison, and tax."
            },
            {
              "id": "q6",
              "answer": "F",
              "textHtml": "a reference to the physical appearance of an animal",
              "explanation": "Paragraph F says Renaissance doctors thought muscles looked like little mice running under the skin.",
              "evidence": "Renaissance doctors thought that the muscles of the human body looked like little mice running around under people’s skin."
            }
          ],
          "options": [
            "A",
          ...
          "questions": [
            {
              ...
              "explanation": "Paragraph C, quoting the WZB report, says self-driving cars will still need to be parked somewhere, so vehicle numbers may not fall.",
              "evidence": "According to a report by the WZB Berlin Social Science Centre, self-driving cars will still need to be parked somewhere, and this will still require a lot of space."
            },
            {
              "id": "q15",
              "answer": "F",
              "textHtml": "a prediction about the use of self-driving cars may be lower than anticipated",
              "explanation": "Paragraph F says the ITF does not expect wide adoption of self-driving cars until 2040, later than some might expect.",
              "evidence": "Despite these possibilities, the ITF estimates that self-driving cars will not be widely adopted until 2040."
            },
            {
              "id": "q16",
              "answer": "G",
              "textHtml": "a suggestion for how to encourage people to share cars",
              "explanation": "Paragraph G recommends investing in public transport and car sharing programmes to encourage shared mobility.",
            ...
            },
            {
              ...
              "explanation": "Paragraph G opens by proposing reduced reliance on private vehicles as the way to prepare for self-driving cars.",
              "evidence": "One approach to preparing for self-driving cars is reducing reliance on private vehicles."
            },
            {
              "id": "q18",
              "answer": "D",
              "textHtml": "a suggestion for how to make streets safer for pedestrians and cyclists",
              "explanation": "Paragraph D says freeing space from parking could create cycling lanes and wider pavements for pedestrians.",
              "evidence": "These cars can relocate to distant parking areas and return when needed, potentially freeing up urban space for cycling lanes and wider sidewalks."
            },
            {
              "id": "q19",
              "answer": "H",
              "textHtml": "a proposal for designing urban infrastructure to accommodate self-driving cars",
              "explanation": "Paragraph H proposes parking areas for both car types plus charging stations and smart traffic systems.",
          ...
          "questions": [
            {
              ...
              "explanation": "Paragraph C, from the WZB report, says self-driving cars will make travel more accessible to the elderly and disabled.",
              "evidence": "The report also says that self-driving cars are likely to increase the number of journeys made by car because they will make car travel more accessible to people who do not currently drive, such as the elderly and the disabled."
            },
            {
              "id": "q21",
              "answer": "A",
              "textHtml": "The use of self-driving cars will mean that fewer people own a car",
              "explanation": "Paragraph B, from the ITF studies, says shared self-driving cars could cut the number of cars needed by 90 percent.",
              "evidence": "These studies show that the number of cars needed to make all the journeys currently made in a city could be reduced by 90%."
            },
            {
              "id": "q22",
              "answer": "A",
      ...
      "groups": [
        {
          ...
          "questions": [
            ...
            },
            {
              ...
              "evidence": "The human brain is proportionally larger than that of other species, and it has a larger neocortex, which is the part of the brain responsible for higher-order thinking."
            },
            {
              "id": "q29",
              "answer": "I",
              ...
              "evidence": "The evolution of pragmatics was likely driven by the need for humans to communicate more effectively in social situations."
            },
            {
              "id": "q30",
              "answer": "F",
              ...
              "evidence": "These vocalizations would have been simple and would have been used to communicate basic information, such as the presence of a predator or the location of food."
            },
            {
              "id": "q31",
              "answer": "D",
              ...
              "evidence": "A third possible theory is that the evolution of language was linked to the evolution of tool use."
            },
            {
              "id": "q32",
              "answer": "A",
              ...
              "evidence": "The answer to this question is not straightforward, and there are several competing theories."
            },
            {
              "id": "q33",
              "answer": "C",
        ...
        },
        {
          ...
          "legendHtml": "<p><strong><span>THE EVOLUTION OF LANGUAGE</span></strong></p><p><span>The evolution of language was probably the result of a combination of factors, including biological, social and (34) ……………… ones. It is likely that the first stage involved the development of (35) ……………… which were used to convey simple messages. In the second stage, it became possible to construct (36) ……………… allowing more complex meanings to be expressed.</span></p>",
          "wordLimit": 1
        },
        {
          ...
          "questions": [
            {
              ...
              "explanation": "Paragraph B lists several brain areas, not just overall size, such as the neocortex and Broca's and Wernicke's areas, as more developed in humans.",
              "evidence": "The human brain also has a larger Broca’s area, which is responsible for speech production, and a larger Wernicke’s area, which is responsible for language comprehension."
            },
            {
              "id": "q38",
              "answer": "True",
              "textHtml": "The ability to use language may have resulted in humans becoming more sociable",
              "explanation": "Paragraph C links language evolution to the need to cooperate and form social groups, tying language to increased sociability.",
              "evidence": "It is possible that the evolution of language was driven by the need for humans to communicate with one another in order to cooperate and form social groups."
            },
            {
              "id": "q39",
              ...
              "explanation": "Paragraph D links language evolution to tool use, which in early humans would have included weapons.",
              "evidence": "A third possible theory is that the evolution of language was linked to the evolution of tool use."
            },
            {
              "id": "q40",
              ...
              "explanation": "Paragraph C mentions dolphins and elephants both having complex communication systems but never compares which is more advanced."
            }
          ],
