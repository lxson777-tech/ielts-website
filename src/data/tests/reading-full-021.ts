      ...
      "groups": [
        {
          ...
          "legendHtml": "<p><strong><span>Questions 1-2</span></strong><br/>\n<span>Choose the correct letter A-D.</span></p><p><span>1. The researchers concluded that</span><br/>\n<span><strong>A</strong> subjects underestimated the time spent ’on hold’.</span><br/>\n<span><strong>B</strong> it is better for companies not to use any ‘on-hold’ music.</span><br/>\n<span><strong>C</strong> light jazz was the most acceptable music overall.</span><br/>\n<span><strong>D</strong> both gender and type of music influence callers’ reaction.</span></p><p><span>2. The researchers recommended that</span><br/>\n<span><strong>A</strong> their client continue to play alternative music.</span><br/>\n<span><strong>B</strong> four types of music should be offered to people ‘on hold’.</span><br/>\n<span><strong>C</strong> advertising is preferable to music.</span><br/>\n<span><strong>D</strong> women can be kept waiting for longer than men.</span></p>"
        },
        {
          "title": "Questions 3-7",
        ...
        },
        {
          ...
          "legendHtml": "<p><strong><span>Questions 8-13</span></strong><br/>\n<span>Do the following statements agree with the claims of the writer? Write</span></p><p><span><strong>YES</strong>                                 if the statement agrees with the views of the writer</span><br/>\n<span><strong>NO</strong>                                    if the statement contradicts the views of the writer</span><br/>\n<span><strong>NOT GIVEN</strong>                 if it is impossible to say what the writer thinks about this</span></p><p><span>8. Businesses want to minimise the time spent ‘on hold’.</span><br/>\n<span>9. The research sample consisted of real clients of a company.</span><br/>\n<span>10. The sample consisted of equal numbers of men and women.</span><br/>\n<span>11. Advertising is considered a poor alternative to ‘on-hold’ music.</span><br/>\n<span>12. The consumer service company surveyed was playing classical music.</span><br/>\n<span>13. Researchers asked subjects only to estimate the length of time they waited ‘on hold’.</span></p><p><br/>\n<br/>\n<br/> </p>"
        }
      ]
    },
    {
      ...
      "groups": [
        ...
        },
        {
          ...
          "legendHtml": "<p><strong><span>Questions 23-25</span></strong><br/>\n<span>Choose the correct letter A-D.</span></p><p><span>23. In 1740 there was a population explosion in Britain because</span><br/>\n<span><strong>A</strong> large numbers of people moved to live in cities.</span><br/>\n<span><strong>B</strong> larger quantities of beer were drunk.</span><br/>\n<span><strong>C</strong> of the health protecting qualities of beer and tea.</span><br/>\n<span><strong>D</strong> of the Industrial Revolution.</span></p><p><span>24. According to the author, the Japanese did not industrialise because they didn’t</span><br/>\n<span><strong>A</strong> like drinking beer.</span><br/>\n<span><strong>B</strong> It want animals to work.</span><br/>\n<span><strong>C</strong> Iike using wheels.</span><br/>\n<span><strong>D</strong> want unemployment.</span></p><p><span>25. Macfarlane thinks he has discovered why</span><br/>\n<span><strong>A</strong> the British drink beer and tea</span><br/>\n<span><strong>B</strong> industrialisation happened in Britain when if did.</span><br/>\n<span><strong>C</strong> the Japanese did not drink beet.</span><br/>\n<span><strong>D</strong> sanitation wasn’t widespread until the 19th century.</span></p><p><br/>\n<br/>\n<br/> </p>"
        }
      ]
    },
    {
      ...
      "groups": [
        ...
        },
        {
          ...
          "legendHtml": "<p><strong><span>Questions 33-37</span></strong><br/>\n<span>Do the following statements reflect the views of the writer of the passage? Write</span></p><p><span><strong>YES</strong>                              if the statement agrees with the views of the writer</span><br/>\n<span><strong>NO</strong>                                if the statement contradicts the views of the writer</span><br/>\n<span><strong>NOT GIVEN</strong>             if it is impossible to say what the writer thinks about this</span></p><p><span>33. The American Intercontinental University includes team-based learning in all its courses on all its campuses.</span><br/>\n<span>34. The composition of teams is changed regularly.</span><br/>\n<span>35. Theoretical problems are the most important team activity.</span><br/>\n<span>36. The team members participate in assessment of other team members.</span><br/>\n<span>37. International students prefer traditional classroom learning to team-based learning.</span></p>"
        },
        {
