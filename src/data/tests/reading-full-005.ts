  ...
  groups: [
    {
      ...
      questions: [
        { id: 'q1', answer: ['antennae', 'antenna'] },
        { id: 'q2', answer: 'head' },
        { id: 'q3', answer: 'thorax' },
        { id: 'q4', answer: ['legs', 'leg'] },
        { id: 'q5', answer: 'abdomen' },
      ],
    },
    {
      title: 'Questions 6–9',
      ...
      questions: [
        { id: 'q6', before: 'Almost all the bees in a hive are female', after: '.', answer: 'workers' },
        { id: 'q7', before: 'A bee packs pollen into baskets on its hind', after: '.', answer: 'legs' },
        { id: 'q8', before: 'For a source close to the hive, a bee performs a', after: 'dance.', answer: 'round' },
        { id: 'q9', before: 'The waggle dance shows direction relative to the', after: '.', answer: 'sun' },
      ],
    },
    {
      ...
      questions: [
        { id: 'q10', textHtml: 'The queen bee directs the work of the colony.', answer: 'False' },
        { id: 'q11', textHtml: 'Pollination is worth more to farming than the honey bees produce.', answer: 'True' },
        { id: 'q12', textHtml: 'Von Frisch’s discovery was immediately accepted by other scientists.', answer: 'False' },
        { id: 'q13', textHtml: 'Bees can perform the waggle dance in complete darkness.', answer: 'True' },
      ],
    },
  ],
};
  ...
  groups: [
    {
      ...
      questions: [
        { id: 'q14', textHtml: 'Paragraph B', answer: 'ii' },
        { id: 'q15', textHtml: 'Paragraph C', answer: 'v' },
        { id: 'q16', textHtml: 'Paragraph D', answer: 'i' },
        { id: 'q17', textHtml: 'Paragraph E', answer: 'vi' },
        { id: 'q18', textHtml: 'Paragraph F', answer: 'iii' },
      ],
    },
    {
      ...
      instructionHtml: 'Complete the sentences. Choose <strong>NO MORE THAN TWO WORDS</strong> from the passage for each answer.',
      questions: [
        { id: 'q19', before: 'The first synthetic plastic, called', after: ', was made in 1907.', answer: 'Bakelite' },
        { id: 'q20', before: 'Baekeland was looking for a substitute for a natural resin called', after: '.', answer: 'shellac' },
        { id: 'q21', before: 'Plastics are made of long molecules known as', after: '.', answer: 'polymers' },
        { id: 'q22', before: 'Some scientists are studying microbes and', after: 'that can digest plastic.', answer: 'enzymes' },
      ],
    },
    {
      ...
      questions: [
        { id: 'q23', textHtml: 'What gives plastics their mix of strength and flexibility?', options: ['their colour', 'their chain-like molecular structure', 'the oil they are made from', 'their low cost'], answer: 'B' },
        { id: 'q24', textHtml: 'Why does plastic waste last so long?', options: ['It is buried too deep.', 'Its polymer chains resist natural breakdown.', 'There is too much of it.', 'It is mixed with metal.'], answer: 'B' },
        { id: 'q25', textHtml: 'One reason recycling plastic is difficult is that', options: ['it is too valuable.', 'different types cannot easily be mixed.', 'it breaks down too fast.', 'microbes eat it first.'], answer: 'B' },
        { id: 'q26', textHtml: 'The main point of the final paragraph is that', options: ['plastic should be banned.', 'useful materials can also be dangerous at scale.', 'plastic has no real uses.', 'technology is always harmful.'], answer: 'B' },
      ],
    },
  ],
};
  ...
  groups: [
    {
      ...
      questions: [
        { id: 'q27', textHtml: 'The written exam has existed for most of human history.', answer: 'No' },
        { id: 'q28', textHtml: 'Exams originally helped to make selection fairer.', answer: 'Yes' },
        { id: 'q29', textHtml: 'Exams should be abolished completely.', answer: 'No' },
        { id: 'q30', textHtml: 'Online exams are easier to cheat in than paper ones.', answer: 'Not Given' },
        { id: 'q31', textHtml: 'No single method can measure everything about a student.', answer: 'Yes' },
      ],
    },
    {
      ...
      questions: [
        { id: 'q32', textHtml: 'The original purpose of the written exam was to', answer: 'A' },
        { id: 'q33', textHtml: 'Critics say exams mainly reward', answer: 'B' },
        { id: 'q34', textHtml: 'When a test has high stakes,', answer: 'C' },
        { id: 'q35', textHtml: 'Defenders value the timed exam because', answer: 'D' },
        { id: 'q36', textHtml: 'The writer predicts that in future', answer: 'E' },
      ],
    },
    {
      ...
      instructionHtml: 'Choose the correct letter, <strong>A</strong>, <strong>B</strong>, <strong>C</strong> or <strong>D</strong>.',
      questions: [
        { id: 'q37', textHtml: 'Before written exams, university places were often given out according to', options: ['ability and merit.', 'personal connection and privilege.', 'written tests.', 'age.'], answer: 'B' },
        { id: 'q38', textHtml: 'Which skills do critics say exams are least able to measure?', options: ['memory and recall', 'creativity and collaboration', 'speed and accuracy', 'spelling and grammar'], answer: 'B' },
        { id: 'q39', textHtml: '“Teaching to the test” refers to', options: ['making tests easier.', 'focusing only on what will be examined.', 'testing teachers.', 'removing exams.'], answer: 'B' },
        { id: 'q40', textHtml: 'What is the main objection defenders raise against continuous assessment?', options: ['It is too difficult.', 'It can be manipulated and is less fair.', 'It takes too long.', 'It favours weak students.'], answer: 'B' },
      ],
    },
  ],
};
