  ...
  "parts": [
    {
      ...
      "stimulus": {
        ...
        "startSeconds": 0.0,
        "endSeconds": 280.76,
        "transcriptHtml": "<p class=\"transcript-note\">Automatic transcript. It may contain small recognition errors; the answer key is authoritative.</p><p><span class=\"ts\">[00:00]</span> Test 4. Instructions. You will hear a number of different recordings and you will have to answer questions on what you hear. There will be time for you to read the instructions and questions. And you will have a chance to check your work. All the recordings will be played once only. The test is in four sections. Write all of your answers in the</p><p><span class=\"ts\">[00:28]</span> listening question booklet. At the end of the real test, you will be given ten minutes to transfer your answers to an answer sheet. Now turn to section one of your booklet. Section one. You are going to hear a conversation between Angela and Mr. Ray. Angela is applying to join the library. Listen to the conversation and</p><p><span class=\"ts\">[00:55]</span> complete the form below. First, you have some time to look at questions one to five. Now we shall begin. You should answer the questions as you listen, because you will never hear the recording a second time. Hello, how can I join the library? Well, you need to make an application. Would you like to do it now? Yes, if I can. One</p><p><span class=\"ts\">[01:31]</span> moment and I&#x27;ll get the form. Now I just need to ask you a few questions before you sign at the bottom. Okay. Your full name, please. Angela, Mary, Price. Price? Yes, that&#x27;s right. Okay, and your address? Apartment three. 86 Bridge Street, Pimlico. Bridge Street, that&#x27;s just near here, isn&#x27;t it? Yes, not very far. Good. So the postcode</p><p><span class=\"ts\">[01:57]</span> must be 2065, right? Yes, that&#x27;s right. Now your telephone number. I need both home and work if you have them. My home number is 8763 5142. And work is 8456 1307. Do you need anything else like ID or something? Yes, your driver&#x27;s license will do, if you have one. Right, it&#x27;s easy to remember. I know it by heart. 4040ac. I&#x27;m afraid I&#x27;ll also</p><p><span class=\"ts\">[02:28]</span> need to see it. Okay, here it is. Thanks. And your date of birth, please? 24 March 1981. Okay, thanks. That&#x27;s the most important part completed. But if you don&#x27;t mind, I&#x27;d also like to ask you a few questions for a survey we&#x27;re conducting. Yes, that&#x27;s okay. Now you have some time to read question six to 10.</p><p><span class=\"ts\">[03:12]</span> As the conversation continues, answer questions six to ten. What kind of books do you like to read? Here&#x27;s a list to look at. Oh, it varies from time to time. But I always like to relax and learn about other countries. I might visit one day. I don&#x27;t like anything too heavy or serious unless it&#x27;s about animals or the environment.</p><p><span class=\"ts\">[03:35]</span> I&#x27;m not really into sport very much. Anything else? Well, I do like entertaining at home. You know, dinner parties. So I suppose you&#x27;ll have something for me in that line. The pictures in those books always make me hungry, although they never seem to turn out exactly as they look in the books. Fine. I think that&#x27;s all I need now, except I need you to sign here</p><p><span class=\"ts\">[03:58]</span> on the application form. Oh, and I almost forgot. The membership fee is $20, which is refundable if you no longer stay a member. There you are. Do I sign at the bottom here? Yes, right. You can borrow books now if you wish, although your membership card won&#x27;t be ready until next week. So if you want to borrow today, you can pick up your card when you return</p><p><span class=\"ts\">[04:20]</span> your first books. That&#x27;s if you want to take some now. I think I will, but I&#x27;ll have a look around first. Okay, take your time. This is the end of section one. You now have half a minute to check your answers.</p>"
      },
      "groups": [
        {
          "title": "Questions 1-5",
    ...
    },
    {
      ...
      "stimulus": {
        ...
        "startSeconds": 280.76,
        "endSeconds": 664.12,
        "transcriptHtml": "<p class=\"transcript-note\">Automatic transcript. It may contain small recognition errors; the answer key is authoritative.</p><p><span class=\"ts\">[04:40]</span> Now turn to section two. You are going to hear a lecture about dining services. First, you have some time to look at questions 11 to 14. Now listen to the tape and answer questions 11 to 14.</p><p><span class=\"ts\">[05:41]</span> Welcome to the dining commons. This is the newest facility on campus, and I&#x27;m proud to say also one of the best. I know that all university students miss eating home-cooked food. Well, this year, we are hoping to provide students with food and services that will make you feel at home, even without your family. The administration has been listening</p><p><span class=\"ts\">[06:07]</span> to the voice of the students. Students gave us frequent suggestions last year as to how we could improve the university. One of the most frequent suggestions was improving the dining options. We have been working hard all summer to come up with ideas that will make student life in the dormitories more pleasant. One of the new options we are offering</p><p><span class=\"ts\">[06:33]</span> in the dining facilities is variety in student meals. Last year, there was a set menu for every dinner. So, if students didn&#x27;t like the food, there was no choice. Students had to eat, whatever was served. But this new dining facility has three completely unique areas, each with a different theme. At every meal, there will be three options for students</p><p><span class=\"ts\">[07:02]</span> to choose from. For example, there might be Italian food at station number one, which might consist of pizza and pasta. At station number two, there would be American food, consisting of hamburgers and hot dogs. At station number three, there could be vegetarian soups and salads, accommodating all the vegetarians. We hope that with the greatest selection of</p><p><span class=\"ts\">[07:31]</span> food, all students will find something to their liking. Now look at questions 15 to 20. Now listen to the tape and answer questions 15 to 20. Not only will students have more options, the food will also be better. Each section of the</p><p><span class=\"ts\">[08:08]</span> facility will have a head chef. These are real chefs that have been trained in culinary school and have been hired specifically by the school to work in the dining facilities. All of the chefs have a speciality. The school is hoping that these chefs will prepare better tasting and more nutritious food. Every student will be able to make suggestions and also</p><p><span class=\"ts\">[08:36]</span> give their input as to which menus taste better. Last year, many students complained that the dining facilities didn&#x27;t have very convenient hours. This year, we hope to change that. We will open for breakfast at 6am to accommodate all the early risers. In the evenings, we will open until midnight for all the students</p><p><span class=\"ts\">[09:03]</span> that like to go for a late night snack. The afternoons will still remain closed, but we will have a student store open that will provide all students with drinks and fruits. The student store will be open every day from 2pm to 5pm. Every student that has paid full tuition and dormitory fees has already paid</p><p><span class=\"ts\">[09:30]</span> for their dining facility fees. Students can eat at any time and in any amount for free. If you are a student that does not live in a dormitory, you can still purchase a dining facility card. This card will entitle you to the full services of the dining facility. This card is available only for students and is not open to the general public. If you are</p><p><span class=\"ts\">[09:58]</span> not a student and wish to dine here, you must purchase meals at the door. There are a few rules to follow. Even though we do not limit the amount of food that can be taken, we do not want students to waste food. Please do not take more than you can eat. Also, every student must clean his or her own trays and plates. We will provide</p><p><span class=\"ts\">[10:27]</span> plates and trays for student use, but please do not abuse these items. Please do not leave your plates on the tables. Your parents are not here to clean up after you anymore, so I hope all students will be responsible. Thank you for your attention and enjoy the upcoming year.</p>"
      },
      "groups": [
        {
    ...
    },
    {
      ...
      "stimulus": {
        ...
        "startSeconds": 664.12,
        "endSeconds": 1037.84,
        "transcriptHtml": "<p class=\"transcript-note\">Automatic transcript. It may contain small recognition errors; the answer key is authoritative.</p><p><span class=\"ts\">[11:04]</span> Now, turn to section 3. In this section, you are going to hear a conversation between Anne and Marsha. In the first part of this conversation, they are talking about the commands of training dogs. First, look at questions 21 to 25. Note the examples which have been done for you.</p><p><span class=\"ts\">[11:59]</span> Now, listen to the first part of the conversation and answer questions 21 to 25. Complete the table showing different commands for different forms of dog training. So that research paper we have to do next, the one about how are different styles of training dogs. How do you think you&#x27;ll approach writing it? You know, I&#x27;ve been thinking</p><p><span class=\"ts\">[12:35]</span> about it. I feel that the best way to write it is to divide the paper into two main parts. In the first part, we&#x27;d be analysing some examples of each style of training dogs. Right, what the styles are. After that, we can talk about how each style can be used that the dogs learn something different from each one. Indeed, maybe we could draw a chart and compare examples</p><p><span class=\"ts\">[12:57]</span> of each style of training one at a time, so the different kinds of training would be simple obedience training. There you would have things like teaching them to sit, stay in one place and so on. Right, so included in here would be simple audio commands like speak. Yes, basic commands are just spoken words, aren&#x27;t they? And then there would be the more guard-oriented</p><p><span class=\"ts\">[13:21]</span> training where the dogs are trained to know a specific place well. Patroling and barking are probably the best examples because most people have seen them in many places, especially in homes. And this would lead us to the attack dog training, which is physical as well as spoken, training the dog to knock someone down and even biting if they have to. Right, so there&#x27;s</p><p><span class=\"ts\">[13:45]</span> another category as well. Sniffing dogs which make up the searching category. I&#x27;ve read that in the UK, every major airport and government building has these dogs to search for all kinds of dangerous items. In the second part of the conversation, Anne and Marsha talk about all kinds of training and what kind of dogs they are suitable to. Look at questions 26 to 30.</p><p><span class=\"ts\">[14:15]</span> As you listen to the conversation, match A, B, C with the following forms of dog training. One has been done as an example for you. Listen carefully and answer questions 26 to 30. I can believe that. Well, we have a good list to build on we&#x27;re finally getting started now. So let&#x27;s try to figure out when each type of dog training should be used. So we have</p><p><span class=\"ts\">[15:00]</span> to figure out the best situation for each type of dog training. Hmm, what do you mean? What I mean is whether each type of training should be used with different kinds of dogs. We could use basic obedience training, for example, and ask whether it&#x27;s more useful for a small dog, a medium sized dog, and so on. In this case, I&#x27;d say obedience training is</p><p><span class=\"ts\">[15:27]</span> best with small dogs because they tend to get excited easily and this will help keep them out of trouble. Okay, that makes sense. Then let&#x27;s look at physical training. Even though some people think it&#x27;s ideal for every breed of dog, I think it&#x27;s better suited to the larger kinds. Small dogs usually just aren&#x27;t smart enough to understand the physical commands</p><p><span class=\"ts\">[15:50]</span> and they can even get hurt from them. The specialized sniffing training is the same. I think they&#x27;re better with the more intelligent breeds of dogs, and they&#x27;re hardly ever useful with really small dogs. Attack training, however, can be useful for every kind of large dog, as long as the dog is treated well and given a lot of care and attention.</p><p><span class=\"ts\">[16:11]</span> Alright, and what about guard training? Barking is an ideal way for small dogs to guard a home. I know they aren&#x27;t big enough to stop a person, but making some noises often all a dog needs to do. Other kinds of guard training like biting though are different. I&#x27;d always plan to teach those to a smart dog, give them a chance to use their brains and defend their</p><p><span class=\"ts\">[16:31]</span> homes. I&#x27;d have to agree, trainers often just teach large dogs to bark at a person when they think something isn&#x27;t right, but if they know how to use physical skills in a bad situation, they could save their owners life someday. Yes, I suppose that different people would have different needs for their pets. Right, and different trainers would recommend</p><p><span class=\"ts\">[16:52]</span> different methods for different breeds. This is the end of Section 3. You now have half a minute to check your answers.</p>"
      },
      "groups": [
        {
    ...
    },
    {
      ...
      "stimulus": {
        ...
        "startSeconds": 1037.84,
        "endSeconds": 1379.35,
        "transcriptHtml": "<p class=\"transcript-note\">Automatic transcript. It may contain small recognition errors; the answer key is authoritative.</p><p><span class=\"ts\">[17:17]</span> Now turn to Section 4. Section 4. You are going to hear a lecture about dorm rooms. First, you have some time to look at questions 31 to 40. Now listen to the tape and answer questions 31 to 40. Welcome to your new home for the upcoming year. These dorm rooms are among the best in the nation</p><p><span class=\"ts\">[18:28]</span> and are the newest ones at this school, so I hope you will all learn to appreciate them and take good care of all the facilities here. I am Gina, and I will be Residential Advisor in this building for the year. Today, I am going to tell you about some of the programs and facilities that are available to you. I will also be telling you the rules</p><p><span class=\"ts\">[18:49]</span> that everyone is expected to abide by. I will be asking you to give me your full attention for the next few minutes. I will first tell you about the facilities that are available to you. The dining facility is located on the first floor of the building. It is open seven days a week from 7 a.m. to midnight. All the food offered to students</p><p><span class=\"ts\">[19:12]</span> is freshly made every day, and my own opinion is that the food is actually quite good. Feel free to come and grab a banana for breakfast or sit down with a group of friends for dinner. Although your meals are served buffet style, please do not waste food. All students are expected to clean their own tables after meals.</p><p><span class=\"ts\">[19:35]</span> In the basement of this building, there is a gym and recreational hall. The gym has workout equipment such as treadmills and weight sets. In the recreational hall, there are ping pong tables and a pool table for student use. You must sign in when using this equipment, and you will be held responsible for any damages or losses.</p><p><span class=\"ts\">[19:56]</span> The gym and recreational hall are open daily from 10 a.m. to 10 p.m. There is a kitchen located on the second floor of this building. Your dorm key will open this door. Inside, there is a refrigerator, a microwave, an oven, and a stove. This room is open 24 hours a day, seven days a week.</p><p><span class=\"ts\">[20:18]</span> If you decide to cook a meal, please be considerate to all the students and clean up after yourself. You can use some food in here, but please do not make a mess. Some students do end up having their food eaten from the fridge, so be careful. Don&#x27;t leave anything that looks like it tastes really good.</p><p><span class=\"ts\">[20:37]</span> Do not leave pots and pans lying around in the kitchen. Please store these in your room. There are many programs being sponsored by our building this year. One of the most popular is our Saturday morning outings. In the past years, these trips have included going fishing, hiking, cycling, ice skating, and even going to the beach.</p><p><span class=\"ts\">[20:58]</span> There will be a listing of schedule events coming out soon. The university sponsors these trips, so transportation will be provided. However, there are usually some costs associated, though they are usually minimal. Our building also has a volleyball team. All students who live in this building are welcome to join.</p><p><span class=\"ts\">[21:18]</span> Last year we won first place in the dorm league. Please sign up at the front desk if you are interested as soon as possible, as there are only 20 spaces available based on a first come, first serve rule. The last things I want to talk about are the rules of our building.</p><p><span class=\"ts\">[21:34]</span> I know rules can be boring, but they are necessary to ensure the welfare of everyone living here. First, noise levels must be kept to a minimum after 11 p.m. Many students have early classes, so for those of you that have the luxury of sleeping until 10, please don&#x27;t stay up late making lots of noise. Secondly, all visitors must sign in at the front door.</p><p><span class=\"ts\">[21:57]</span> Even if you have friends that are regular visitors, they must still always sign in. This rule is to prevent theft and robbery from occurring. Thirdly, alcohol and drugs are not permitted in this dorm in any place or at any time. Lastly, just be safe and have a great time.</p><p><span class=\"ts\">[22:15]</span> University is the greatest time of your life, so make the most of it. Thank you all for your attention. This is the end of Section 4. You now have 30 seconds to check your answers.</p><p><span class=\"ts\">[22:52]</span> Thank you.</p>"
      },
      "groups": [
        {
