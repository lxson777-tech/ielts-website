  ...
  groups: [
    {
      ...
      questions: [
        { id: 'q1', textHtml: 'why the upper floors of early tall buildings were unpopular', answer: 'C' },
        { id: 'q2', textHtml: 'the problem with building very high using stone or brick', answer: 'A' },
        { id: 'q3', textHtml: 'reasons why skyscrapers first appeared in particular cities', answer: 'D' },
        { id: 'q4', textHtml: 'the main difficulty faced by the tallest modern towers', answer: 'F' },
        { id: 'q5', textHtml: 'the idea that tall buildings express wealth and pride', answer: 'E' },
      ],
    },
    {
      title: 'Questions 6–9',
      ...
      questions: [
        { id: 'q6', before: 'In traditional buildings, the weight of the structure is carried by the', after: '.', answer: 'walls' },
        { id: 'q7', before: 'The key breakthrough for tall buildings was the', after: 'frame.', answer: 'steel' },
        { id: 'q8', before: 'Elisha Otis demonstrated a safety', after: 'in 1854.', answer: 'elevator' },
        { id: 'q9', before: 'The tallest modern towers use huge', after: 'to reduce swaying.', answer: 'counterweights' },
      ],
    },
    {
      ...
      questions: [
        { id: 'q10', textHtml: 'The steel frame allowed outer walls to contain more windows.', answer: 'True' },
        { id: 'q11', textHtml: 'Passenger lifts did not exist before Otis’s invention.', answer: 'False' },
        { id: 'q12', textHtml: 'The 1871 Chicago fire was started deliberately.', answer: 'Not Given' },
        { id: 'q13', textHtml: 'The title of world’s tallest building has moved to Asia and the Middle East.', answer: 'True' },
      ],
    },
  ],
};
  ...
  groups: [
    {
      ...
      questions: [
        ...
        { id: 'q15', textHtml: 'Paragraph B', answer: 'v' },
        { id: 'q16', textHtml: 'Paragraph C', answer: 'i' },
        { id: 'q17', textHtml: 'Paragraph D', answer: 'vii' },
        { id: 'q18', textHtml: 'Paragraph E', answer: 'vi' },
        { id: 'q19', textHtml: 'Paragraph F', answer: 'iii' },
      ],
    },
    {
      ...
      instructionHtml: 'Complete the sentences. Choose <strong>NO MORE THAN TWO WORDS</strong> from the passage for each answer.',
      questions: [
        { id: 'q20', before: 'The twilight zone begins about', after: 'metres below the surface.', answer: ['two hundred', '200'] },
        { id: 'q21', before: 'Most twilight-zone animals can make their own light through', after: '.', answer: 'bioluminescence' },
        { id: 'q22', before: 'The nightly rise and fall of ocean animals is called the vertical', after: '.', answer: 'migration' },
        { id: 'q23', before: 'Scientists worry that large-scale fishing could disrupt the carbon', after: '.', answer: 'pump' },
      ],
    },
    {
      ...
      questions: [
        { id: 'q24', textHtml: 'The vertical migration is described as the largest on Earth because', options: ['the animals travel the furthest.', 'so many creatures take part in it.', 'it happens only once a year.', 'it can be seen from the surface.'], answer: 'B' },
        { id: 'q25', textHtml: 'Animals of the twilight zone help the climate by', options: ['absorbing carbon dioxide directly.', 'carrying carbon down into the deep ocean.', 'releasing oxygen at night.', 'warming the surface water.'], answer: 'B' },
        { id: 'q26', textHtml: 'Why are fishing fleets turning to the twilight zone?', options: ['Its fish are easier to catch.', 'The surface waters have been heavily fished.', 'Governments have encouraged it.', 'Its fish are more valuable.'], answer: 'B' },
      ],
    },
  ],
};
  ...
  groups: [
    {
      ...
      questions: [
        { id: 'q27', textHtml: 'The wisdom of crowds works only when people judge independently.', answer: 'Yes' },
        { id: 'q28', textHtml: 'Social media generally improves the quality of group judgements.', answer: 'No' },
        { id: 'q29', textHtml: 'Prediction markets are more accurate than review scores.', answer: 'Not Given' },
        { id: 'q30', textHtml: 'A crowd can be trusted on questions that require specialist knowledge.', answer: 'No' },
        { id: 'q31', textHtml: 'The size of a crowd can make a wrong answer seem authoritative.', answer: 'Yes' },
      ],
    },
    {
    ...
    },
    {
      ...
      instructionHtml: 'Choose the correct letter, <strong>A</strong>, <strong>B</strong>, <strong>C</strong> or <strong>D</strong>.',
      questions: [
        { id: 'q37', textHtml: 'In the ox-weight example, the crowd’s average is accurate because', options: ['everyone is an expert.', 'the high and low errors cancel out.', 'people copy the best guesser.', 'the ox is easy to weigh.'], answer: 'B' },
        { id: 'q38', textHtml: 'What does the writer say can happen to an online review score?', options: ['It always reflects true quality.', 'Early votes can influence it for a long time.', 'It cannot be manipulated.', 'It improves over time.'], answer: 'B' },
        { id: 'q39', textHtml: 'Averaging opinions works badly for medical questions because', options: ['people share the same misconceptions.', 'too few people answer.', 'doctors disagree.', 'the questions are too simple.'], answer: 'A' },
        { id: 'q40', textHtml: 'The writer’s overall conclusion is that the crowd', options: ['should always be trusted.', 'should always be ignored.', 'is useful under the right conditions.', 'is never better than an expert.'], answer: 'C' },
      ],
    },
  ],
};
