...
const test: PracticeTest = {
  ...
  "source": {
    ...
    "url": "https://practicepteonline.com/ielts-reading-test-306/",
  ...
  "parts": [
    {
      ...
      "stimulus": {
        ...
        "paragraphs": [
          {
            "html": "<span>The presence of street trees can dramatically improve urban environments in a variety of ways.</span>"
          },
          {
            "html": "<span>Street trees are not only a key component of the urban landscape, but also provide numerous environmental, economic and social benefits. Despite this, in many towns and cities, they are frequently seen as a problem, and in recent years, large numbers have been removed or severely cut back.</span>"
          },
          {
            "html": "<span>Street trees are trees that are located on public land along streets and boulevards, and in parks. They are usually the responsibility of local governments, although in some cases they may be privately owned. In the past, street trees were planted and maintained by local authorities for the public good. However, with the increasing privatisation of public space, the responsibility for street trees has shifted from the public to the private domain, and they are now often seen as a liability.</span>"
          },
          {
            "html": "<span>Street trees can make urban areas much more pleasant places in which to live, and there are many studies to show that they are associated with a wide range of benefits. For example, they remove pollutants from the air, provide shade, and reduce the urban heat island effect, which is caused by hard surfaces such as concrete and asphalt storing heat from the sun. They also improve water quality, reduce flooding, and decrease the amount of water that ends up in drainage systems. In addition, they can save energy by shading buildings and reducing the need for air conditioning in summer.</span>"
          },
          {
            "html": "<span>Street trees also have significant social benefits. They make streets more pleasant to walk along, and provide shade and shelter for pedestrians. They also act as a buffer between pedestrians and traffic, and reduce traffic noise. In addition, they can provide a sense of place and identity, and improve the quality of life for residents. Studies have shown that street trees can reduce crime, improve mental health, and increase property values. They can also provide habitat for wildlife, and improve biodiversity in urban areas.</span>"
          },
          {
            "html": "<span>Despite these benefits, street trees are often seen as a problem. One reason for this is that they can cause damage to infrastructure, such as roads, footpaths and underground services. This is often due to the fact that they are planted in small pits with limited space for root growth, which can lead to roots damaging infrastructure as they search for water and nutrients. In addition, street trees can be seen as a nuisance because they drop leaves, fruit and branches, which can be messy and require cleaning up. They can also block light and views, and interfere with overhead wires and signage.</span>"
          },
          {
            "html": "<span>Another reason why street trees are seen as a problem is that they can be expensive to maintain. They require regular pruning to keep them in good condition, and to prevent them from interfering with infrastructure. They also need to be watered, fertilised and protected from pests and diseases. In addition, they can be damaged by vehicles, vandalism and extreme weather events, which can result in costly repairs or replacement.</span>"
          },
          {
            "html": "<span>In recent years, there has been a trend towards removing street trees, or replacing them with smaller, more manageable species. This is often done to reduce maintenance costs, and to prevent damage to infrastructure. However, this can result in a loss of the benefits that street trees provide. In some cases, street trees are replaced with artificial trees, which do not provide the same benefits as real trees.</span>"
          },
          {
            "html": "<span>There are a number of ways in which the benefits of street trees can be maximised, and the problems minimised. One way is to plant the right tree in the right place. This means choosing tree species that are suitable for the local climate, soil and growing conditions, and that will not cause damage to infrastructure. It also means planting trees in locations where they will provide the most benefits, such as along streets with high pedestrian traffic, or in areas with high levels of air pollution.</span>"
          },
          {
            "html": "<span>Another way to maximise the benefits of street trees is to provide them with adequate space and resources to grow. This means planting them in large pits with good quality soil, and providing them with regular watering, fertilising and pruning. It also means protecting them from damage by vehicles, vandalism and extreme weather events.</span>"
          },
          {
            "html": "<span>In conclusion, street trees are a vital component of the urban landscape, and provide numerous environmental, economic and social benefits. However, they are often seen as a problem, and are frequently removed or severely cut back. By planting the right tree in the right place, and providing them with adequate space and resources to grow, the benefits of street trees can be maximised, and the problems minimised.</span>"
          }
        ]
      },
      "groups": [
      ...
      "groups": [
        {
          ...
          "instructionHtml": "Reading passage has seven paragraphs, A-G. Which paragraph contains the following information? Write the correct letter, A-G, in boxes 14-20 on your answer sheet. NB You may use any letter more than once",
          "questions": [
            {
              "id": "q14",
              "answer": "B",
          ...
          "questions": [
            {
              "id": "q21",
              "answer": "C",
              "textHtml": "According to the writer, schools in the past",
              "options": [
            ...
            },
            {
              "id": "q22",
              "answer": "A",
              "textHtml": "According to the writer, technology allows students to",
              "options": [
            ...
            },
            {
              "id": "q23",
              "answer": "B",
              "textHtml": "According to the writer, some students may do worse than others if",
              "options": [
      ...
      "groups": [
        {
          ...
          "type": "paragraph-matching",
          "instructionHtml": "Reading passage has seven paragraphs, A-G. Which paragraph contains the following information? Write the correct letter, A-G, in boxes 27-33 on your answer sheet. NB You may use any letter more than once.",
          "questions": [
            {
              "id": "q27",
              "answer": "B",
        ...
        },
        {
          ...
          "instructionHtml": "Do the following statements agree with the claims of the writer in reading passage? In boxes 34-38 on your answer sheet, write",
          "questions": [
            {
              "id": "q34",
              "answer": "Not given",
