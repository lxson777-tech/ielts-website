...
/* Translation rule for this file. Everything that ADVISES is marked with
   nt() and translated at the point of display, through the lazily loaded
   "band-guides" dictionary part (src/lib/i18n/dict/parts.ts) rather than the
   main chunk: this file is 72 KB and only the band ladder and the band
   report show it.

   `example.before` and `example.after` are deliberately NOT marked. They are
   the English a student writes or says, shown side by side so the difference
   between a band 6 and a band 7 sentence is visible. Translating them would
   destroy the only thing the example is for. `example.why`, which explains
   the difference, IS translated. Band numbers and criterion names stay
   English throughout, as they do on a real examiner report. */
...
export interface BandStepGuide {
  ...
  stopThis: string[];
  /** A before/after pair showing the change. `before` and `after` are the
      student's own English and stay English; `why` is the explanation and is
      translated. */
  ...
  taskResponse: [
    {
      ...
      doThis: [
        ...
        nt('Give each main idea its own paragraph, at least two body paragraphs.'),
        nt('Check that your answer responds to the exact question asked, not a related question you find easier.'),
      ],
      stopThis: [
        nt('Stop writing a response vague enough to answer several different questions. Tie every sentence to the exact wording of the prompt.'),
        nt('Stop leaving your opinion out of opinion essays.'),
      ],
      example: {
        ...
        why: nt('The first version states no position and could belong to almost any essay. The second names a clear opinion in one sentence, which band 5 requires even if the rest of the essay stays simple.'),
      },
      practice:
    ...
    },
    {
      ...
      doThis: [
        ...
        nt('Delete any sentence that does not support one of your main ideas.'),
        nt('Keep your position identical from your introduction to your conclusion.'),
      ],
      stopThis: [
        nt('Stop giving the part of the question you find less interesting only one sentence.'),
        nt('Stop adding facts or examples that do not connect to the point you are making.'),
      ],
      example: {
    ...
    },
    {
      ...
      stopThis: [
        nt('Stop stating an idea and moving straight to the next one without extending it.'),
        nt('Stop letting your position drift into vague "both sides have a point" language by the conclusion.'),
      ],
      example: {
    ...
    },
    {
      ...
      doThis: [
        ...
        nt('Check each claim for a hidden generalisation ("everyone", "in today\'s society") and replace it with something specific.'),
        nt('Balance the depth of every part of the task so none feels thinner than the rest.'),
      ],
      stopThis: [
        nt('Stop supporting points with sweeping generalisations. Name a specific case instead.'),
        nt('Stop giving one paragraph noticeably less development than the others.'),
      ],
      example: {
        ...
        why: nt('The first sentence is a broad claim with no real support. The second grounds the same point in a specific, checkable fact, which is what removes the "over-generalise" weakness band 7 still allows.'),
      },
      practice:
        nt('Take 3 general claims from a past essay and rewrite each with one specific, named example in place of the vague statement. 15 minutes.'),
    },
    {
      from: 8,
      to: 9,
      ...
      doThis: [
        ...
        nt('Re-read the prompt after finishing and confirm nothing was left implicit or half-answered.'),
      ],
      stopThis: [
        nt('Stop treating any single part of the task as "good enough". At band 9 every part needs full development.'),
      ],
      example: {
        ...
        why: nt('The first sentence states a position without engaging its complexity. The second extends the idea fully: who is affected, a fair counterpoint, and how the counterpoint is addressed, which is the standard band 9 asks for.'),
      },
      practice:
  ...
  coherenceCohesion: [
    {
      ...
      doThis: [
        ...
        nt('Open each paragraph with a sentence that names its main idea.'),
        nt('Use a pronoun (it, this, they) to refer back to something already named, instead of repeating the same noun every time.'),
      ],
      stopThis: [
        nt('Stop writing without paragraph breaks.'),
        nt('Stop repeating the same word three or more times in one paragraph when a pronoun or synonym would work.'),
      ],
      example: {
        ...
        why: nt('The first version repeats "cars" three times with no connection between the sentences. The second uses "they" and "their" to refer back, and links the ideas with "since", which is the basic referencing band 5 is checking for.'),
      },
      practice:
        nt('Take one paragraph you have already written. Underline every repeated noun and replace at least half of them with a pronoun or synonym. 10 minutes.'),
    },
    {
      from: 5,
      to: 6,
      ...
      doThis: [
        ...
        nt('Limit yourself to one or two linking words per paragraph rather than one per sentence.'),
        nt('Give every paragraph one clear topic. Do not mix two ideas in the same paragraph.'),
      ],
      stopThis: [
        nt('Stop starting three sentences in a row with the same linking word ("Moreover... Moreover... Furthermore...").'),
        nt('Stop mixing unrelated ideas inside a single paragraph.'),
      ],
      example: {
        ...
        why: nt('Repeating "Moreover" three times is the over-use band 5 struggles with. The revised version links the first two related ideas naturally and marks the contrast with "However", which reads as effective rather than mechanical.'),
      },
      practice:
        nt('Find every linking word in a past essay. Circle any word used more than twice and replace at least two with a different connective or with no connective at all where the logic is already clear. 15 minutes.'),
    },
    {
      from: 6,
      to: 7,
      ...
      doThis: [
        ...
        nt('Make sure referencing words (it, this, these) are always unambiguous: a reader must know exactly what they point to.'),
        nt('Read through the whole essay and check that each paragraph flows into the next without a logical jump.'),
      ],
      stopThis: [
        nt('Stop using "and" or "also" as your main way of connecting ideas across the whole essay.'),
        nt('Stop letting a paragraph drift onto a second, unrelated idea partway through.'),
      ],
      example: {
        ...
        why: nt('Using "also" twice treats an addition and a contrast as if they were the same relationship. "For instance" and "that said" mark the actual logical relationships, which is the range of devices band 7 is looking for.'),
      },
      practice:
        nt('Write the topic sentence only for each paragraph of a planned essay. Check each one states a single, distinct idea with no overlap. 10 minutes.'),
    },
    {
      from: 7,
      to: 8,
      ...
      doThis: [
        ...
        nt('Combine cohesive techniques inside one paragraph (a reference word, a substitution, and one linking word) instead of relying on a single repeated device.'),
        nt('Reread specifically for over-use of "however", "moreover", and "furthermore", and cut or vary as needed.'),
      ],
      stopThis: [
        nt('Stop opening every paragraph with the same formulaic linker. Vary how paragraphs begin.'),
        nt('Stop inserting a linking word where the logic is already obvious without one.'),
      ],
      example: {
        ...
        why: nt('The original stacks "Furthermore" onto a sentence that does not need it and buries the actual point. The revision drops the unneeded connector and lets the sentence structure itself carry the logical link, which reads as more controlled at band 8.'),
      },
      practice:
        nt('Take a finished essay and delete every linking word you can remove without losing meaning. Compare the two versions for clarity. 15 minutes.'),
    },
    {
      from: 8,
      to: 9,
      ...
      doThis: [
        ...
        nt('Check that your topic sentences alone, read in order, summarise the whole essay clearly.'),
      ],
      stopThis: [
        nt('Stop relying on any single connecting device more than once or twice in the whole essay.'),
      ],
      example: {
        ...
        why: nt('The first sentence signals its logic with two separate connective phrases stacked together. The second achieves the same addition through word choice ("also") and sentence rhythm alone, which is closer to the invisible cohesion band 9 describes.'),
      },
      practice:
        nt('Rewrite one paragraph with zero linking words, relying only on sentence order and word choice to carry the logic. Check it still reads clearly. 15 minutes.'),
    },
  ],
  ...
  lexicalResource: [
    {
      ...
      doThis: [
        ...
        nt('Check the spelling of any word you use more than once in the essay.'),
        nt('Use a full sentence to express an idea rather than a fragment that avoids using more vocabulary.'),
      ],
      stopThis: [
      ...
      example: {
        ...
        why: nt('The first version relies entirely on "very" plus a basic adjective, repeated twice. The second uses two different, more precise words, which is the minimally adequate range band 5 is checking for.'),
      },
      practice:
        nt('List the 5 words you use most often in your essays (usually good, bad, big, important, very). Find one stronger alternative for each and use it in a practice sentence. 10 minutes.'),
    },
    {
      from: 5,
      to: 6,
      ...
      doThis: [
        ...
        nt('Paraphrase the question\'s own key terms in your introduction rather than repeating them exactly.'),
        nt('Double-check the spelling of the key content words you use repeatedly across the essay.'),
      ],
      stopThis: [
        nt('Stop copying the exact wording of the question into your essay.'),
      ],
      example: {
    ...
    },
    {
      ...
      doThis: [
        ...
        nt('Replace at least three basic words per essay (good, bad, big, very) with a more precise alternative.'),
        nt('Vary your vocabulary so the same content noun is not repeated more than twice across the essay.'),
      ],
      stopThis: [
        nt('Stop writing "very + adjective" (very important, very good). Use one stronger word instead.'),
        nt('Stop copying phrases directly from the question into your essay.'),
      ],
      example: {
        ...
        why: nt('"Very important" and "good decisions" are safe, general phrases. "Have a responsibility" and "sound decisions" are natural collocations with more precision, which shows the awareness of style and collocation band 7 asks for.'),
      },
      practice:
        nt('Look up 5 common collocations for your weakest essay topic (for example, environment: "carbon emissions", "renewable sources", "raise awareness"). Write one sentence using each. 15 minutes.'),
    },
    {
      from: 7,
      to: 8,
      ...
      doThis: [
        ...
        nt('Spend the final two minutes of proofreading purely on the spelling of your key vocabulary.'),
        nt('Use collocations naturally throughout the essay, not just once as a one-off flourish.'),
      ],
      stopThis: [
        nt('Stop settling for the first vocabulary choice that comes to mind. Review word choices for precision on your final read-through.'),
        nt('Stop letting spelling slips appear on words you use more than once.'),
      ],
      example: {
        ...
        why: nt('"Good effects and bad effects" is accurate but generic. "Tangible benefits and hidden costs" conveys a more precise meaning while still being accurate, which is the fluent, flexible use of a wide range band 8 requires.'),
      },
      practice:
        nt('Take 3 sentences from a past essay using "good" or "bad". Rewrite each with a more precise word pair. Check spelling of every new word used. 15 minutes.'),
    },
    {
      from: 8,
      to: 9,
      ...
      doThis: [
        ...
        nt('Check every collocation you use is completely natural, aiming for zero avoidable inaccuracies.'),
      ],
      stopThis: [
        nt('Stop inserting an advanced word purely to impress if it does not fit naturally in context. Only use vocabulary you are certain is accurate.'),
      ],
      example: {
        ...
        why: nt('The first sentence uses rare words that sound inserted for effect rather than natural. The second conveys the same idea with vocabulary that a highly competent native writer would actually choose, which is what "natural and sophisticated control" means at band 9.'),
      },
      practice:
        nt('Read one paragraph aloud. Flag any word that feels forced rather than natural, and replace it with a simpler, more natural choice. 15 minutes.'),
    },
  ],
  ...
  grammaticalRange: [
    {
      ...
      doThis: [
        ...
        nt('Write in complete sentences. Avoid fragments that lack a main verb or subject.'),
        nt('Keep subject-verb agreement correct in your simple sentences at minimum ("she goes", not "she go").'),
      ],
      stopThis: [
        nt('Stop writing only short, simple sentences throughout the entire essay.'),
        nt('Stop mixing up basic tense forms within the same paragraph.'),
      ],
      example: {
    ...
    },
    {
      ...
      doThis: [
        ...
        nt('Check subject-verb agreement and articles (a, an, the) on your key nouns.'),
        nt('Vary sentence openings. Do not start every sentence with the subject.'),
      ],
      stopThis: [
        nt('Stop overusing a single complex structure (only "because" clauses, for example). Mix in others.'),
        nt('Stop letting a grammar error change the actual meaning of a sentence.'),
      ],
      example: {
    ...
    },
    {
      ...
      doThis: [
        ...
        nt('Check that every verb tense matches the timeframe you are describing.'),
        nt('Proofread specifically for punctuation: commas around clauses, and correct use of semicolons if you use them.'),
      ],
      stopThis: [
        nt('Stop relying on the same complex structure repeatedly. Mix in relative clauses, conditionals, and passive voice.'),
        nt('Stop leaving comma splices (two full sentences joined only by a comma) uncorrected.'),
      ],
      example: {
        ...
        why: nt('The first sentence is a comma splice joining two independent clauses incorrectly. The second uses a relative clause ("an opinion that has grown") to connect the ideas correctly, which is the variety of complex structures band 7 asks for.'),
      },
      practice:
        nt('Write one sentence using a relative clause (who/which/that), one using a conditional (if...), and one using the passive voice, all about the same topic. 15 minutes.'),
    },
    {
      from: 7,
      to: 8,
      ...
      doThis: [
        ...
        nt('Read every complex sentence aloud. If it does not sound natural, simplify it or fix it.'),
        nt('Fix every article (a/an/the) and preposition error you can spot while proofreading.'),
      ],
      stopThis: [
        nt('Stop attempting a complex structure you are unsure of without checking it. Use a simpler, correct structure instead if in doubt.'),
        nt('Stop leaving more than one or two errors uncorrected after proofreading.'),
      ],
      example: {
    ...
    },
    {
      ...
      doThis: [
        ...
        nt('Proofread twice: once purely for meaning, and once purely for grammar and punctuation.'),
      ],
      stopThis: [
        nt('Stop treating any error as acceptable. At this level, even one avoidable slip should be caught on rereading.'),
      ],
      example: {
  ...
  fluencyCoherence: [
    {
      ...
      doThis: [
        ...
        nt('Practise giving full-sentence answers to simple personal questions until they come without hesitation.'),
        nt('Link two simple sentences together with and, but, or so, instead of stopping after each one.'),
      ],
      stopThis: [
        nt('Stop pausing silently for several seconds before you start answering.'),
        nt('Stop giving one-word or single-sentence answers when you actually have more to say.'),
      ],
      example: {
        ...
        why: nt('The first answer has long silent pauses and stops after two words. The second keeps going without a gap and links two ideas with "and", which is the flow band 5 asks for even in simple speech.'),
      },
      practice:
        nt('Record yourself answering 8 Part 1 style questions (favourite food, hometown, weekend plans) out loud, starting within 2 seconds of hearing each question. 15 minutes.'),
    },
    {
      from: 5,
      to: 6,
    ...
    },
    {
      ...
      doThis: [
        ...
        nt('Self-correct smoothly by simply restating the word or phrase, rather than stopping and apologising.'),
        nt('Practise extended answers on abstract Part 3 topics, not only familiar Part 1 ones.'),
      ],
      stopThis: [
        nt('Stop stopping every few seconds to search for a word. If a word will not come, paraphrase around it and keep moving.'),
        nt('Stop finishing Part 2 answers well under the 2-minute mark.'),
      ],
      example: {
    ...
    },
    {
      ...
      doThis: [
        ...
        nt('Let any pause come from thinking about the idea itself, not from struggling with grammar or vocabulary.'),
        nt('Record yourself and count self-corrections. Aim for no more than one or two per answer.'),
      ],
      stopThis: [
        nt('Stop self-correcting grammar mid-sentence more than once or twice per answer.'),
        nt('Stop hesitating specifically because you are translating from your first language in your head.'),
      ],
      example: {
        ...
        why: nt('The first answer self-corrects grammar and searches for words twice. The second is fluent throughout, with any thinking happening about the content rather than the language itself, which is the occasional-only hesitation band 8 asks for.'),
      },
      practice:
        nt('Prepare 8 topic-specific words for a Part 3 theme (work, environment, technology). Answer 3 questions on that theme using at least 2 of the words each time. 20 minutes.'),
    },
    {
      from: 8,
      to: 9,
      ...
      doThis: [
        ...
        nt('Use cohesive devices so naturally that a listener would not notice them as a technique.'),
      ],
      stopThis: [
        nt('Stop treating any remaining hesitation as acceptable if it comes from language rather than thinking. Work specifically on removing it.'),
      ],
      example: {
        ...
        why: nt('Both answers are fluent, but the second develops the idea further, with a genuine qualification ("though I\'d say... for certain groups"), showing the fuller development band 9 expects even at speed.'),
      },
      practice:
        nt('Record a full mock interview (all 3 parts). Listen back and mark every hesitation. Note whether each was about the idea or about the language. 20 minutes.'),
    },
  ],
  ...
  lexicalResource: [
    {
      ...
      doThis: [
        ...
        nt('Learn 5 to 10 words for the IELTS topics you find hardest (education, work, environment).'),
        nt('Answer every Part 3 question even if the topic feels unfamiliar, using general vocabulary rather than staying silent.'),
      ],
      stopThis: [
        nt('Stop going silent when a topic feels unfamiliar. Use general words to talk around it instead.'),
      ],
      example: {
    ...
    },
    {
      ...
      stopThis: [
        nt('Stop relying on the exact words from the question in your answer.'),
        nt('Stop using the same 3 to 4 all-purpose adjectives (good, bad, nice, interesting) for everything.'),
      ],
      example: {
        ...
        why: nt('The first answer just repeats "technology" and "education" from the question with the vague word "good". The second paraphrases into "digital tools" and "learning" and adds a specific benefit, which is the successful paraphrase band 6 rewards.'),
      },
      practice:
        nt('Take 5 Part 3 questions. Answer each without repeating any key noun from the question itself, using a paraphrase instead. 15 minutes.'),
    },
    {
      from: 6,
      to: 7,
      whatChanges:
        nt('Band 7 asks you to use your vocabulary flexibly to discuss a variety of topics, including some less common or idiomatic vocabulary with some awareness of style and collocation (natural word pairings), and to paraphrase effectively. Some inappropriate word choices are still allowed at this level.'),
      doThis: [
      ...
      stopThis: [
        ...
        nt('Stop giving the same simple answer style throughout Part 3 as you did in Part 1.'),
      ],
      example: {
        ...
        why: nt('The first answer repeats "problem" and uses "do more about" loosely. The second uses the natural collocation "tackle this issue" and "growing concern", which shows the awareness of style and collocation band 7 asks for.'),
      },
      practice:
        nt('Learn 5 collocations for one Part 3 theme. Answer 3 questions on that theme, using at least one collocation naturally in each answer. 15 minutes.'),
    },
    {
      from: 7,
      to: 8,
      whatChanges:
        nt('Band 8 asks you to use a wide vocabulary readily and flexibly to convey precise meaning, skilfully using less common and idiomatic vocabulary, with only occasional inaccuracies, and to paraphrase effectively whenever needed. Band 7 allows some inappropriate word choices more broadly.'),
      doThis: [
        nt('Choose the most precise word for each idea, not just an acceptable one, for example "meticulous" instead of "very careful" where it fits.'),
        nt('Use idiomatic expressions confidently and naturally, not as a one-off "showcase" phrase.'),
        nt('Paraphrase confidently the moment a word does not come to mind, without breaking your fluency to search for it.'),
        nt('Vary vocabulary across the whole test so words are not repeated when a synonym is available.'),
      ],
      stopThis: [
        nt('Stop using an idiom or advanced phrase that does not quite fit, just to sound impressive. Precision matters more than difficulty.'),
        nt('Stop breaking your flow to visibly search for a "better" word.'),
      ],
      example: {
        ...
        why: nt('The first answer uses "good" twice for two different qualities. The second chooses two precise, natural phrases ("cost-effective" and "environmentally friendly"), which is the precise, flexible use band 8 requires.'),
      },
      practice:
        nt('Take one answer you gave using "good" or "bad" twice. Rewrite it choosing a precise, different word for each instance. 15 minutes.'),
    },
    {
      from: 8,
      to: 9,
      ...
      doThis: [
        ...
        nt('Keep vocabulary control consistent for the full 11 to 14 minutes, with no dip in quality on harder Part 3 questions.'),
      ],
      stopThis: [
        nt('Stop letting vocabulary quality drop on the topics you have not specifically prepared for.'),
      ],
      example: {
  ...
  grammaticalRange: [
    {
      ...
      doThis: [
        ...
        nt('Build answers around two connected sentences rather than isolated fragments.'),
        nt('Correct yourself out loud when you notice a tense mistake, rather than continuing past it.'),
      ],
      stopThis: [
        nt('Stop relying only on memorised phrases for common questions.'),
        nt('Stop avoiding subordinate clauses altogether.'),
      ],
      example: {
        ...
        why: nt('The first version is three short, disconnected sentences with a grammar error ("Is good"). The second links them with "because" and "even though", which is the attempted subordinate structure band 5 asks for.'),
      },
      practice:
        nt('Answer 5 familiar Part 1 questions, each using one subordinate clause (because, when, if, which). 15 minutes.'),
    },
    {
      from: 5,
      to: 6,
      ...
      doThis: [
        ...
        nt('Keep basic tense and subject-verb agreement accurate even while attempting harder structures.'),
        nt('Notice which specific error you make most often and drill it in isolation.'),
      ],
      stopThis: [
        nt('Stop attempting a complex structure so unfamiliar that the sentence collapses. Simplify instead if it is not ready yet.'),
        nt('Stop making the same basic tense error repeatedly across the test.'),
      ],
      example: {
    ...
    },
    {
      ...
      doThis: [
        ...
        nt('Practise conditionals specifically (if I had..., if I were...), since they stand out clearly at band 7.'),
        nt('Vary sentence length: mix short, direct sentences with longer complex ones.'),
      ],
      stopThis: [
        nt('Stop using only one type of complex structure throughout the whole test.'),
        nt('Stop letting grammar mistakes persist on the same familiar-topic sentences you have already practised.'),
      ],
      example: {
    ...
    },
    {
      ...
      doThis: [
        ...
        nt('Practise unscripted, spontaneous complex sentences on unfamiliar Part 3 topics, not memorised ones.'),
        nt('Fix any remaining systematic error (one you make the same way repeatedly) through targeted drilling.'),
      ],
      stopThis: [
        nt('Stop making the same grammar mistake in a pattern across multiple answers. That counts as systematic, not occasional.'),
        nt('Stop relying on complex structures only in prepared, memorised sections.'),
      ],
      example: {
    ...
    },
    {
      ...
      example: {
        ...
        why: nt('Both are fluent and accurate, but the second is tighter and more natural, dropping the filler opener and using "reshape" and a spontaneous-sounding addition, which reads closer to unscripted native speech at band 9.'),
      },
      practice:
        nt('Record a full mock Part 3 discussion. Listen for any grammar error and judge honestly whether a native speaker would ever make that particular one. 20 minutes.'),
    },
  ],
  ...
  pronunciation: [
    {
      ...
      stopThis: [
        nt('Stop speaking so fast that individual sounds get dropped or blurred.'),
        nt('Stop guessing at stress placement on multi-syllable words. Look it up and practise it.'),
      ],
      example: {
    ...
    },
    {
      ...
      doThis: [
        ...
        nt('Record a short answer and check whether a listener could understand it throughout, even with some mispronounced words.'),
        nt('Work specifically on the individual sounds that most often confuse listeners for your first language background.'),
      ],
      stopThis: [
        nt('Stop pronouncing every word with equal, flat stress.'),
        nt('Stop running all your words together without any chunking or phrase breaks.'),
      ],
      example: {
    ...
    },
    {
      ...
      doThis: [
        ...
        nt('Practise weak forms: the quick, unstressed pronunciation of small words like "to", "and", "of" in fast natural speech (for example, "cup of tea" sounding like "cuppa tea").'),
        nt('Check that listeners understand you throughout a whole answer, not just in short bursts.'),
      ],
      stopThis: [
        nt('Stop letting your pronunciation control drop in the second half of longer answers.'),
        nt('Stop pronouncing every small function word (to, of, and) fully and heavily, as if reading aloud.'),
      ],
      example: {
        ...
        why: nt('Stressing every word equally, as the first version does, buries the words that actually carry the meaning. Putting sentence stress on centre, weekend and friends, and pausing briefly at one natural phrase boundary, is the chunking and stress control band 7 asks for.'),
      },
      practice:
        nt('Speak on one Part 2 cue card for the full 2 minutes. Record it, then compare your pronunciation control in the first 30 seconds versus the last 30 seconds. 20 minutes.'),
    },
    {
      from: 7,
      to: 8,
      ...
      doThis: [
        ...
        nt('Reduce lapses on your hardest individual sounds until they appear rarely, not routinely.'),
        nt('Get feedback from a fluent English speaker on whether your accent ever actually blocks understanding, and target only those specific moments.'),
      ],
      stopThis: [
        nt('Stop accepting occasional unintelligible words as normal. At this level, lapses should be rare, not routine.'),
        nt('Stop worrying about removing your accent entirely. The goal is intelligibility, not sounding native.'),
      ],
      example: {
        ...
        why: nt('Band 7 can produce the right words for a contrast without the intonation to match it. Using a rise on the first item and a fall on the second is a concrete, controllable way to make that contrast audible, which is the deliberate use of intonation band 8 asks for.'),
      },
      practice:
        nt('Do a full 3-part mock speaking test. Rate your own pronunciation control out of 5 for each part separately, and note exactly where it drops. 20 minutes.'),
    },
    {
      from: 8,
      to: 9,
      ...
      stopThis: [
        nt('Stop treating any remaining lapse as acceptable. At band 9, control is sustained without exception.'),
      ],
      example: {
        ...
        why: nt('Band 8 already allows "occasional lapses". Band 9 asks for the same wide range of features but with the last of those occasional lapses removed, so listening feels completely effortless throughout.'),
      },
      practice:
        nt('Record a full mock interview. Mark the exact moments, if any, where a listener would need to concentrate to understand you, and work on those specific sounds or words. 20 minutes.'),
    },
  ],
};
