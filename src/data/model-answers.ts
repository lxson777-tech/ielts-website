/* Model-answer bank for the Writing section. Original material, written to
   ...
   ten get the full three-band set — the "first twelve get three bands"
...
export const MODEL_ANSWERS: ModelAnswer[] = [
  /* ───────────────────────── w2-technology-social ───────────────────────── */
  {
    ...
    highlights: [
      ...
      { phrase: 'This is a big problem because', note: 'cohesive device overused, this exact phrase is leaned on more than once in the essay' },
    ...
    criteria: {
      ...
      coherence: "Paragraphing is logical, with an introduction, two body paragraphs and a conclusion, and basic linkers like 'Firstly' and 'Secondly' guide the reader through it. Cohesion, though, relies on a narrow set of repeated devices ('This is a big problem because', 'for example') rather than a varied range.",
      lexical: "Vocabulary is adequate for the topic (face-to-face interaction, social isolation) but limited in range, with words like 'problem' and 'important' repeated several times. There is little attempt at less common vocabulary beyond the topic phrases the question invites.",
      grammar: "A mix of simple and complex sentences is attempted, but subject-verb agreement slips ('technology are making', 'people who does not know', 'it reduce') recur throughout the response. These errors rarely block understanding, but their frequency is what keeps accuracy at this band.",
    },
  },
  {
    promptId: 'w2-technology-social',
  ...
  /* ───────────────────────── w2-university-purpose ───────────────────────── */
  {
    ...
    criteria: {
      ...
      lexical: "Topic vocabulary such as 'vocational subject' and 'well-rounded' is used correctly, but general vocabulary is repeated ('people think', 'important') rather than varied. Word forms occasionally slip, with a plural idea sometimes expressed through a singular noun.",
  ...
  /* ───────────────────────── w2-city-traffic ───────────────────────── */
  {
    ...
    criteria: {
      ...
      lexical: "Topic vocabulary from the question ('gridlock', 'carbon emissions', 'congestion charge') is used appropriately, showing preparation for this kind of topic. General vocabulary is more repetitive, with 'problem' and 'people' both appearing several times.",
  ...
  /* ───────────────────────── w2-adv-disadv-remote-work ───────────────────────── */
  {
    ...
    criteria: {
      ...
      lexical: "Relevant topic vocabulary ('work-life balance', 'flexible working arrangement') is used correctly, but plural and word-form errors reduce the accuracy of the range attempted. General vocabulary such as 'good' and 'people' is repeated rather than varied.",
  ...
  /* ───────────────────────── w2-opinion-environment-responsibility ───────────────────────── */
  {
    ...
    criteria: {
      ...
      lexical: "Topic vocabulary ('environmental legislation', 'carbon footprint', 'hold accountable') is used correctly and shows good preparation for the subject. Basic vocabulary such as 'big' and 'government' is repeated often, limiting the overall range.",
  ...
  /* ───────────────────────── w1-line-museum-visitors ───────────────────────── */
  {
    ...
    text: [
      ...
      'Overall, visitor numbers rose at all three museums over the period, although Tate Modern saw the sharpest increase and eventually overtook both of its rivals.',
      "In 2010, the Science Museum attracted the most visitors, at around 2.7 million, followed closely by the Natural History Museum, while Tate Modern lagged behind with roughly 1.8 million. Over the next few years, all three lines climbed steadily, with the gap between them narrowing considerably by 2015.",
      "From 2015 onwards, Tate Modern's growth accelerated sharply, overtaking the Natural History Museum in 2016 and the Science Museum a year later. By 2019, Tate Modern led with approximately 4 million visitors, while the other two museums had reached around 3.2 million each, a gap that had barely existed at the start of the decade.",
    ],
    highlights: [
      { phrase: 'Overall, visitor numbers rose at all three museums over the period, although Tate Modern saw the sharpest increase and eventually overtook both of its rivals', note: 'clear overview giving the two key features, exactly what Task Achievement requires' },
      { phrase: 'narrowing considerably by 2015', note: 'precise description of the gap between lines, not just the lines themselves' },
      { phrase: "Tate Modern's growth accelerated sharply", note: 'accurate grading of the rate of change, not just its direction' },
      { phrase: 'overtaking the Natural History Museum in 2016 and the Science Museum a year later', note: 'specific, well-sequenced comparison using selected data rather than every point on the graph' },
      { phrase: 'By 2019, Tate Modern led with approximately 4 million visitors', note: 'clear final comparison that closes the description logically' },
    ],
    criteria: {
      taskAchievement: "The overview accurately identifies the two most important features, the general upward trend and Tate Modern's overtaking of the other two, which are exactly what an examiner looks for. Selected figures are used to support each comparison rather than listing every data point on the graph.",
      ...
      lexical: "A good range of graph-specific vocabulary ('overtook', 'accelerated', 'lagged behind') is used accurately. Numbers are rounded and expressed naturally rather than copied directly from the graph.",
      grammar: 'A range of past tense forms and comparative structures is used accurately throughout, appropriate for describing a completed historical trend. Minor errors are rare and do not affect meaning.',
    },
  },
  {
    promptId: 'w1-line-museum-visitors',
    ...
    text: [
      ...
      "Overall, all three museums enjoyed rising attendance throughout the period, but the standout feature is Tate Modern's trajectory: starting as the least visited of the three, it overtook both rivals within the decade to finish comfortably in the lead.",
      "At the outset, the Science Museum and the Natural History Museum were fairly closely matched, at roughly 2.7 and 2.5 million visitors respectively, well ahead of Tate Modern's 1.8 million. All three figures climbed steadily until the middle of the decade, by which point the gap separating them had narrowed noticeably.",
      "Thereafter, Tate Modern's growth accelerated markedly, overtaking the Natural History Museum in 2016 and the Science Museum the following year. By 2019 it had reached approximately 4 million visitors, roughly 800,000 ahead of its two closely matched rivals.",
    ],
    highlights: [
      { phrase: 'starting as the least visited of the three, it overtook both rivals within the decade to finish comfortably in the lead', note: 'single, precisely constructed sentence that captures the whole trend efficiently' },
      { phrase: 'fairly closely matched, at roughly 2.7 and 2.5 million visitors respectively', note: 'precise, natural comparison of two figures within one sentence' },
      { phrase: 'by which point the gap separating them had narrowed noticeably', note: 'describes the relationship between the three lines, not just their individual movement' },
      { phrase: "Tate Modern's growth accelerated markedly", note: 'accurately grades the rate of change using precise, less common vocabulary' },
      { phrase: 'roughly 800,000 ahead of its two closely matched rivals', note: 'precise final comparison drawing the report to a natural close' },
    ],
    criteria: {
      taskAchievement: "The overview is precise and fully developed, capturing both the shared upward trend and Tate Modern's distinctive overtaking trajectory in a single, well-constructed statement. Every figure selected supports a genuine comparison rather than simply repeating a data point.",
      coherence: "The report is organised with clear, logical progression from overview to early, then later, detail, and transitions between paragraphs feel natural rather than mechanical. Cohesion is achieved through precise reference ('thereafter', 'by which point') rather than repeated simple linkers.",
      lexical: "A wide, precise range of graph vocabulary ('trajectory', 'closely matched', 'accelerated markedly') is used accurately and naturally throughout. Numbers are rounded and compared with genuine flexibility rather than mechanically restated.",
      grammar: 'A wide range of complex structures, including a non-defining relative clause and a comparative with precise quantification, is used with complete accuracy. The report reads fluently, with no errors of any kind.',
    },
  },
  /* ───────────────────────── w1-bar-internet-access ───────────────────────── */
  {
    ...
    text: [
      ...
      'In 2000, the UK already had a relatively high level of internet penetration, at around 45%, whereas the figure for the other three countries was under 10%. By 2020, the UK had reached almost 95%, a comparatively modest rise given its high starting point.',
      'The most dramatic changes occurred in Brazil and India, both of which saw internet access rise to around 70% and 60% respectively by 2020. Nigeria also improved considerably, reaching roughly 50%, though it remained the country with the lowest household internet access of the four throughout the period shown in the chart.',
    ],
    highlights: [
      ...
      { phrase: 'remained the country with the lowest household internet access of the four throughout the period', note: 'accurate superlative comparison closing the report logically' },
    ],
    criteria: {
      taskAchievement: 'The overview correctly identifies both the shared upward trend and the key difference in starting points, which together explain the pattern seen across all four countries. Figures are selected and rounded appropriately to support comparison rather than to list every value.',
  ...
  },
  {
    ...
    text: [
      ...
      'In 2000, UK household connectivity already stood at around 45%, compared with figures below 10% in Brazil, Nigeria and India. Two decades later, the UK had approached near-universal access at close to 95%, though this represented a smaller proportional leap than the gains made elsewhere.',
      'Brazil and India recorded the most striking transformations, climbing to roughly 70% and 60% respectively, while Nigeria, despite a marked improvement to around 50%, remained the country with the least widespread broadband access of the four by the end of 2020.',
    ],
    highlights: [
      ...
      { phrase: 'represented a smaller proportional leap than the gains made elsewhere', note: 'sophisticated relative comparison, not just an absolute figure' },
      { phrase: 'recorded the most striking transformations', note: 'precise, evaluative vocabulary selecting the two most significant countries' },
  ...
  /* ───────────────────────── w1-pie-household-spending ───────────────────────── */
  {
    ...
    text: [
      ...
      'Overall, the most significant change is the sharp rise in the share of the household budget spent on housing, while spending on food fell considerably over the same forty-year period.',
      'In 1980, food accounted for the largest share of spending, at around 30%, followed by housing at 20%. Transport and leisure each made up roughly 15% to 20% of the budget, with the remaining, smaller share going to other expenses.',
      "By 2020, housing had become the dominant category, rising to around 35% of the budget, while food's share had fallen to under 15%. Leisure spending also declined slightly, suggesting that a rising cost of living had left households with noticeably less disposable income for non-essential spending than they had enjoyed forty years earlier.",
    ],
    highlights: [
      { phrase: 'the most significant change is the sharp rise in the share of the household budget spent on housing', note: 'overview correctly identifies the single most important feature rather than listing every category' },
      { phrase: 'while spending on food fell considerably over the same forty-year period', note: 'second key feature added to complete a proper two-part overview' },
      ...
      { phrase: 'suggesting that a rising cost of living had left households with noticeably less disposable income', note: 'brief, appropriate interpretation that connects the two changes described' },
    ],
    criteria: {
      taskAchievement: 'The overview correctly identifies the two most significant changes, rising housing costs and falling food spending, which is exactly what this pair of pie charts calls for. Figures are selected and rounded to support clear comparison across the two charts.',
      ...
      lexical: "Topic vocabulary ('household budget', 'disposable income', 'cost of living') is used accurately and appropriately. There is minimal repetition of basic vocabulary across the report.",
  ...
  },
  {
    ...
    text: [
      ...
      'The clearest trend across the whole forty-year period shown is a marked reallocation of the household budget away from food and towards housing, which overtook food to become the largest single category by 2020.',
      'In 1980, food dominated household spending at around 30%, with housing a distant second at 20%; transport and leisure together accounted for a further 35%, leaving only a modest remainder for other, considerably smaller expenses.',
      "By 2020, this hierarchy had reversed entirely: housing had climbed to roughly 35% of the budget, while food's share had shrunk to under 15%. Leisure spending edged down slightly too, a pattern entirely consistent with a rising cost of living gradually squeezing discretionary spending across the board over the course of four decades.",
    ],
    highlights: [
      ...
      { phrase: 'food dominated household spending at around 30%, with housing a distant second at 20%', note: 'two figures compared naturally within a single sentence' },
      { phrase: 'this hierarchy had reversed', note: 'concise, precise way of signalling the key change between the two charts' },
      { phrase: 'a pattern entirely consistent with a rising cost of living gradually squeezing discretionary spending across the board', note: 'sophisticated closing interpretation drawing the whole report together' },
    ],
    criteria: {
      taskAchievement: 'The overview offers a genuinely analytical summary, describing the reallocation between categories rather than listing figures in isolation, which is a sophisticated reading of the two charts. Every figure supports a clear, purposeful comparison.',
      coherence: "The report develops with clear, logical structure and transitions ('by 2020, this hierarchy had reversed') that link the two charts precisely rather than mechanically. Cohesion is achieved through sophisticated reference rather than repeated simple linkers.",
      lexical: "Precise, wide-ranging vocabulary ('reallocation', 'distant second', 'discretionary spending') is used accurately and naturally throughout. There is no repetition of basic vocabulary anywhere in the report.",
  ...
  /* ───────────────────────── w1-table-rent-prices ───────────────────────── */
  {
    ...
    text: [
      ...
      'Overall, rent rose steadily in three of the four cities over the period, with New York recording the highest rent throughout, while Tokyo was the only city where prices did not consistently increase.',
    ...
    highlights: [
      { phrase: 'rent rose steadily in three of the four cities over the period, with New York recording the highest rent throughout, while Tokyo was the only city where prices did not consistently increase', note: 'overview correctly identifies both the general pattern and the clearest exception' },
  ...
  },
  {
    ...
    text: [
      ...
      'Berlin, meanwhile, nearly doubled from its modest starting point to $950, while Tokyo alone finished the period cheaper, in relative terms, than it had begun.',
    ],
    highlights: [
      ...
      { phrase: 'Tokyo alone finished the period cheaper, in relative terms, than it had begun', note: "sophisticated closing observation that reframes the table's most surprising feature" },
    ],
    criteria: {
      ...
      lexical: "Precise, wide-ranging vocabulary ('divergence', 'stagnated', 'in relative terms') is used accurately and naturally throughout. There is no repetition of basic vocabulary anywhere in the report.",
  ...
  /* ───────────────────────── w1-process-plastic-recycling ───────────────────────── */
  {
    ...
    text: [
      ...
      'Overall, the process consists of six main stages, beginning with the collection of used bottles and ending with the production of new plastic goods, and it is entirely man-made, with each stage carried out mechanically.',
    ...
    highlights: [
      { phrase: 'the process consists of six main stages, beginning with the collection of used bottles and ending with the production of new plastic goods', note: 'gives the number of stages and the start/end points, exactly what a process overview needs' },
  ...
  },
  {
    ...
    band: 8.5,
    text: [
      'The diagram outlines the process through which plastic bottles are recycled, tracing six distinct stages from initial collection to the manufacture of new products.',
      ...
      'The process is initiated when used bottles are gathered from households and public collection points, then transported by lorry to a dedicated recycling facility. Here, they undergo sorting by colour and plastic type, followed by a thorough washing stage to eliminate any residual liquid or contamination.',
    ...
    highlights: [
      { phrase: 'tracing six distinct stages from initial collection to the manufacture of new products', note: 'efficient overview combining stage count and start/end points in one clause' },
    ...
    criteria: {
      ...
      lexical: "A wide, precise range of process vocabulary ('mechanically shredded', 'molten state', 'residual contamination') is used accurately and naturally throughout. There is no repetition of basic vocabulary anywhere in the report.",
  ...
  /* ───────────────────────── w1-map-riverside-town ───────────────────────── */
  {
    ...
    text: [
      ...
      'In 1995, Riverside consisted mainly of farmland to the south, a small cluster of houses near the river, and a Post Office close to the town centre. The river ran through the middle of the town, crossed by a single bridge connecting the two halves.',
      "Today, the Post Office has been demolished and replaced by a school in the same location, while most of the farmland to the south has been converted into a large shopping centre. In addition, new housing has been built to the west of the river, considerably expanding the town's residential area, although the river, bridge and original houses remain exactly as they were.",
    ],
    highlights: [
      ...
      { phrase: 'has been demolished and replaced by a school in the same location', note: 'precise passive structure appropriate for describing a man-made change' },
  ...
  },
  {
    ...
    text: [
      ...
      'In 1995, the town was dominated by farmland to the south, with a modest cluster of houses beside the river and a Post Office near the centre, the two halves of the town linked by a single bridge.',
      'Today, that Post Office site now houses a school, and the former farmland has given way to a substantial shopping centre. New residential development has also considerably expanded the town to the west of the river, even as the river, bridge and original houses persist exactly as they were, untouched by the surrounding change.',
    ],
    highlights: [
  ...
  /* ───────────────────────── w1-combination-water-usage ───────────────────────── */
  {
    ...
    text: [
      ...
      'Overall, agriculture consumed by far the largest share of water in 2020, and total water consumption rose steadily between 2000 and 2020, more than compensating for any efficiency gains that might have occurred.',
      "According to the bar chart, agriculture accounted for 70% of water use in 2020, considerably more than industry at 25% and domestic use, which made up only 5% of the total. This suggests that agricultural practices are the primary driver of a country's overall water demand.",
      'The table shows that total consumption rose from 18.2 billion litres per day in 2000 to 21.6 billion in 2010, and further to 25.9 billion by 2020. This steady rise indicates that, despite any improvements in efficiency, overall demand for water continued to increase throughout the two decades shown.',
    ],
    highlights: [
      ...
      { phrase: "the primary driver of a country's overall water demand", note: 'brief, appropriate interpretation that follows naturally from the figures given' },
      ...
      { phrase: 'despite any improvements in efficiency, overall demand for water continued to increase', note: "closing observation that connects the two visuals' findings together" },
    ],
    criteria: {
  ...
  },
  {
    ...
    text: [
      ...
      'Taken together, the two visuals reveal a country where agriculture dominates water use overwhelmingly, and where total demand has risen steadily even as the population presumably became more aware of water conservation.',
      ...
      'Meanwhile, the table reveals a steady upward trajectory in total consumption, climbing from 18.2 billion litres per day in 2000 to 21.6 billion in 2010, and reaching 25.9 billion by 2020. Read alongside the sector breakdown, this rise implies that growing agricultural demand is likely to have been the principal force driving the twenty-year increase.',
    ],
    highlights: [
      ...
      { phrase: 'Read alongside the sector breakdown, this rise implies that growing agricultural demand is likely to have been the principal force driving the twenty-year increase', note: 'sophisticated closing sentence that connects the chart and table into one conclusion' },
    ],
    criteria: {
      taskAchievement: "The overview genuinely synthesises the two visuals into a single insight, rather than summarising each one in isolation, which is the mark of a strong combination-task response. The closing sentence goes further still, using the sector data to interpret the table's trend.",
  ...
  /* ───────────────────────── w1-line-social-media-time ───────────────────────── */
  {
    ...
    text: [
      ...
      'In 2015, teenagers spent around two hours a day on social media, compared with roughly ninety minutes for young adults and only thirty minutes for older adults. All three figures rose steadily over the following years, with the gap between teenagers and young adults gradually shrinking.',
      "By 2023, teenagers' daily average had nearly doubled to almost four hours, while young adults had risen even more sharply to around three and a half hours, closing in on teenagers' figure. Older adults also increased their usage, though they remained well behind the other two groups throughout.",
    ],
    highlights: [
      ...
      { phrase: 'compared with roughly ninety minutes for young adults and only thirty minutes for older adults', note: 'efficient three-way comparison within a single sentence' },
    ...
    criteria: {
      ...
      lexical: "A good range of vocabulary for describing trends and comparison ('narrowed the gap', 'closing in on', 'nearly doubled') is used accurately. Numbers are rounded and expressed naturally.",
  ...
  },
  {
    ...
    text: [
      ...
      'In 2015, teenagers led clearly at around two hours daily, more than double the roughly ninety minutes recorded for young adults and well ahead of the thirty minutes typical of older adults. All three lines rose steadily thereafter, though not at an equal pace.',
      "By 2023, teenagers' average had climbed to nearly four hours, but young adults had risen even more steeply to approximately three and a half hours, all but converging with teenagers by the end of the period. Older adults, while also increasing their usage considerably, remained the clear outlier throughout, never approaching the levels seen among younger users.",
    ],
    highlights: [
      ...
      { phrase: 'more than double the roughly ninety minutes recorded for young adults', note: 'precise ratio-based comparison rather than a simple figure' },
  ...
  /* ───────────────────────── w1-bar-tourist-arrivals ───────────────────────── */
  {
    ...
    text: [
      ...
      'Overall, tourist arrivals increased in three of the four countries over the period, with France recording the largest rise, while Thailand was the only country to see a decline in visitor numbers.',
      'In 2015, France received the most tourists at around 85 million, followed by Spain at 68 million, with Thailand and Mexico further behind at approximately 30 million and 32 million respectively. By 2023, France had grown further to reach roughly 100 million visitors, maintaining its position as the most visited country of the four.',
      'Spain also grew steadily, reaching around 85 million by 2023, while Mexico experienced only modest growth to approximately 42 million. Thailand, in contrast, was the sole country to see arrivals fall, dropping to around 25 million by 2023, well below its 2015 figure.',
    ],
    highlights: [
      { phrase: 'tourist arrivals increased in three of the four countries over the period, with France recording the largest rise, while Thailand was the only country to see a decline', note: 'overview correctly identifies both the general pattern and the clear exception' },
      { phrase: 'France received the most tourists at around 85 million, followed by Spain at 68 million', note: 'efficient ranking of the top two countries within a single sentence' },
      ...
      { phrase: 'Mexico experienced only modest growth', note: "precise grading of change, distinguishing Mexico's smaller rise from France and Spain's larger ones" },
      { phrase: 'the sole country to see arrivals fall', note: "confident superlative used to highlight the chart's key exception" },
    ],
    criteria: {
      taskAchievement: 'The overview correctly identifies the general upward trend and clearly highlights Thailand as the exception, which are the two most important features of this bar chart. Figures are selected from both years to support comparison across all four countries.',
      ...
      lexical: "A good range of vocabulary for describing change ('modest growth', 'decline', 'maintaining its position') is used accurately. Numbers are rounded and compared naturally rather than simply listed.",
  ...
  },
  {
    ...
    text: [
      ...
      "In 2015, France was already the most visited of the four, drawing around 85 million tourists, well ahead of Spain's 68 million and considerably further ahead of Thailand and Mexico, which each attracted roughly 30 million. By 2023, France had extended this lead further still, climbing to approximately 100 million visitors.",
      "Spain also grew substantially over the same period, reaching around 85 million, while Mexico's growth was comparatively modest, edging up to 42 million. Thailand, uniquely among the four, saw arrivals fall to around 25 million, a decline that leaves it visibly adrift from the other three by 2023.",
    ],
    highlights: [
      ...
      { phrase: 'had extended this lead further still', note: "precise phrase describing France's continued dominance across both years" },
      { phrase: "Mexico's growth was comparatively modest, edging up to 42 million", note: 'accurately grades the size of the change using precise, less common vocabulary' },
      { phrase: 'a decline that leaves it visibly adrift from the other three by 2023', note: "sophisticated closing image that reinforces the overview's central contrast" },
    ],
    criteria: {
      ...
      coherence: "The report develops with clear, logical structure, comparing all four countries within each year before moving on, and precise reference ('this lead further still') links the two years smoothly. Structure is sophisticated throughout.",
      lexical: "Precise, wide-ranging vocabulary ('adrift', 'comparatively modest', 'extended this lead') is used accurately and naturally throughout. There is no repetition of basic vocabulary anywhere in the report.",
  ...
  /* ───────────────────────── w1-pie-public-transport-reasons ───────────────────────── */
  {
    ...
    highlights: [
      ...
      { phrase: 'reflecting the practical benefits many people associate with buses and trains over driving', note: 'brief, appropriate interpretation of why convenience might rank second' },
  ...
  },
  {
    ...
    highlights: [
      ...
      { phrase: 'shedding eight hours to reach 40 by 2020, yet still trailing Germany', note: 'combines two comparisons, the size of the change and the final ranking, in one sentence' },
